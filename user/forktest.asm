...
forktest(void)
{
  ...
  34:	44050513          	addi	a0,a0,1088 # 470 <audit_read+0xe>
  ...
  56:	46e50513          	addi	a0,a0,1134 # 4c0 <audit_read+0x5e>
  ...
  6c:	41850513          	addi	a0,a0,1048 # 480 <audit_read+0x1e>
  ...
  7e:	41e50513          	addi	a0,a0,1054 # 498 <audit_read+0x36>
  ...
  ae:	40650513          	addi	a0,a0,1030 # 4b0 <audit_read+0x4e>
