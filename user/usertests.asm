...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      14:	b9078793          	addi	a5,a5,-1136 # 7ba0 <malloc+0x2678>
      18:	638c                	ld	a1,0(a5)
      1a:	6790                	ld	a2,8(a5)
      1c:	6b94                	ld	a3,16(a5)
      1e:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      70:	5b450513          	addi	a0,a0,1460 # 5620 <malloc+0xf8>
      74:	3fc050ef          	jal	5470 <printf>
      exit(1);
      78:	4505                	li	a0,1
      ...
      9a:	8082                	ret
{
      ...
      aa:	59a50513          	addi	a0,a0,1434 # 5640 <malloc+0x118>
      ae:	3c2050ef          	jal	5470 <printf>
      exit(1);
      b2:	4505                	li	a0,1
...
00000000000000b8 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ca:	59250513          	addi	a0,a0,1426 # 5658 <malloc+0x130>
  ...
  fd = open("doesnotexist", 0);
      ...
      e0:	59c50513          	addi	a0,a0,1436 # 5678 <malloc+0x150>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      fc:	56850513          	addi	a0,a0,1384 # 5660 <malloc+0x138>
     100:	370050ef          	jal	5470 <printf>
    exit(1);
     104:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     110:	57c50513          	addi	a0,a0,1404 # 5688 <malloc+0x160>
     114:	35c050ef          	jal	5470 <printf>
    exit(1);
     118:	4505                	li	a0,1
...
000000000000011e <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     186:	52e50513          	addi	a0,a0,1326 # 56b0 <malloc+0x188>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1b0:	52450513          	addi	a0,a0,1316 # 56d0 <malloc+0x1a8>
     1b4:	2bc050ef          	jal	5470 <printf>
    exit(1);
     1b8:	4505                	li	a0,1
...
0000000000000240 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     260:	49c50513          	addi	a0,a0,1180 # 56f8 <malloc+0x1d0>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     274:	488a0a13          	addi	s4,s4,1160 # 56f8 <malloc+0x1d0>
     278:	4b09                	li	s6,2
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2e0:	42c50513          	addi	a0,a0,1068 # 5708 <malloc+0x1e0>
     2e4:	18c050ef          	jal	5470 <printf>
      exit(1);
     2e8:	4505                	li	a0,1
     ...
     2f8:	43450513          	addi	a0,a0,1076 # 5728 <malloc+0x200>
     2fc:	174050ef          	jal	5470 <printf>
        exit(1);
     300:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     31e:	42650513          	addi	a0,a0,1062 # 5740 <malloc+0x218>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     332:	41298993          	addi	s3,s3,1042 # 5740 <malloc+0x218>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     36e:	3d650513          	addi	a0,a0,982 # 5740 <malloc+0x218>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     382:	34a58593          	addi	a1,a1,842 # 56c8 <malloc+0x1a0>
     386:	485040ef          	jal	500a <write>
     38a:	4785                	li	a5,1
     38c:	02f50d63          	beq	a0,a5,3c6 <badwrite+0xc0>
    printf("write failed\n");
     390:	00005517          	auipc	a0,0x5
     394:	3d050513          	addi	a0,a0,976 # 5760 <malloc+0x238>
     398:	0d8050ef          	jal	5470 <printf>
    exit(1);
     39c:	4505                	li	a0,1
     39e:	44d040ef          	jal	4fea <exit>
      printf("open junk failed\n");
     3a2:	00005517          	auipc	a0,0x5
     3a6:	3a650513          	addi	a0,a0,934 # 5748 <malloc+0x220>
     3aa:	0c6050ef          	jal	5470 <printf>
      exit(1);
     3ae:	4505                	li	a0,1
     3b0:	43b040ef          	jal	4fea <exit>
    printf("open junk failed\n");
     3b4:	00005517          	auipc	a0,0x5
     3b8:	39450513          	addi	a0,a0,916 # 5748 <malloc+0x220>
     3bc:	0b4050ef          	jal	5470 <printf>
    exit(1);
     3c0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3d0:	37450513          	addi	a0,a0,884 # 5740 <malloc+0x218>
...
00000000000004aa <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     4c8:	6dc78793          	addi	a5,a5,1756 # 7ba0 <malloc+0x2678>
     4cc:	638c                	ld	a1,0(a5)
     4ce:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4fa:	27aa8a93          	addi	s5,s5,634 # 5770 <malloc+0x248>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     58c:	1f050513          	addi	a0,a0,496 # 5778 <malloc+0x250>
     590:	6e1040ef          	jal	5470 <printf>
      exit(1);
     594:	4505                	li	a0,1
     ...
     5a2:	1f250513          	addi	a0,a0,498 # 5790 <malloc+0x268>
     5a6:	6cb040ef          	jal	5470 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	20c50513          	addi	a0,a0,524 # 57c0 <malloc+0x298>
     5bc:	6b5040ef          	jal	5470 <printf>
      exit(1);
     5c0:	4505                	li	a0,1
     5c2:	229040ef          	jal	4fea <exit>
      printf("pipe() failed\n");
     5c6:	00005517          	auipc	a0,0x5
     5ca:	22a50513          	addi	a0,a0,554 # 57f0 <malloc+0x2c8>
     5ce:	6a3040ef          	jal	5470 <printf>
      exit(1);
     5d2:	4505                	li	a0,1
     ...
     5e0:	22450513          	addi	a0,a0,548 # 5800 <malloc+0x2d8>
     5e4:	68d040ef          	jal	5470 <printf>
      exit(1);
     5e8:	4505                	li	a0,1
...
00000000000005ee <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     60c:	59878793          	addi	a5,a5,1432 # 7ba0 <malloc+0x2678>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     640:	1f4b0b13          	addi	s6,s6,500 # 5830 <malloc+0x308>
    ...
    n = write(fds[1], "x", 1);
     ...
     650:	07cb8b93          	addi	s7,s7,124 # 56c8 <malloc+0x1a0>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     6d6:	16650513          	addi	a0,a0,358 # 5838 <malloc+0x310>
     6da:	597040ef          	jal	5470 <printf>
      exit(1);
     6de:	4505                	li	a0,1
     ...
     6ec:	16850513          	addi	a0,a0,360 # 5850 <malloc+0x328>
     6f0:	581040ef          	jal	5470 <printf>
      exit(1);
     6f4:	4505                	li	a0,1
     6f6:	0f5040ef          	jal	4fea <exit>
      printf("pipe() failed\n");
     6fa:	00005517          	auipc	a0,0x5
     6fe:	0f650513          	addi	a0,a0,246 # 57f0 <malloc+0x2c8>
     702:	56f040ef          	jal	5470 <printf>
      exit(1);
     706:	4505                	li	a0,1
     708:	0e3040ef          	jal	4fea <exit>
      printf("pipe write failed\n");
     70c:	00005517          	auipc	a0,0x5
     710:	17450513          	addi	a0,a0,372 # 5880 <malloc+0x358>
     714:	55d040ef          	jal	5470 <printf>
      exit(1);
     718:	4505                	li	a0,1
     ...
     726:	17650513          	addi	a0,a0,374 # 5898 <malloc+0x370>
     72a:	547040ef          	jal	5470 <printf>
      exit(1);
     72e:	4505                	li	a0,1
...
0000000000000734 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     780:	f3450513          	addi	a0,a0,-204 # 56b0 <malloc+0x188>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     7a4:	f1050513          	addi	a0,a0,-240 # 56b0 <malloc+0x188>
     7a8:	083040ef          	jal	502a <open>
     7ac:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     7ae:	4581                	li	a1,0
     7b0:	00005517          	auipc	a0,0x5
     7b4:	f0050513          	addi	a0,a0,-256 # 56b0 <malloc+0x188>
  ...
  write(fd1, "abcdef", 6);
     ...
     7e6:	14658593          	addi	a1,a1,326 # 5928 <malloc+0x400>
     7ea:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     81c:	e9850513          	addi	a0,a0,-360 # 56b0 <malloc+0x188>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     850:	07c50513          	addi	a0,a0,124 # 58c8 <malloc+0x3a0>
     854:	41d040ef          	jal	5470 <printf>
    exit(1);
     858:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     864:	08850513          	addi	a0,a0,136 # 58e8 <malloc+0x3c0>
     868:	409040ef          	jal	5470 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     86c:	8656                	mv	a2,s5
     86e:	85d2                	mv	a1,s4
     870:	00005517          	auipc	a0,0x5
     874:	08850513          	addi	a0,a0,136 # 58f8 <malloc+0x3d0>
     878:	3f9040ef          	jal	5470 <printf>
    exit(1);
     87c:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     888:	09450513          	addi	a0,a0,148 # 5918 <malloc+0x3f0>
     88c:	3e5040ef          	jal	5470 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     890:	8656                	mv	a2,s5
     892:	85d2                	mv	a1,s4
     894:	00005517          	auipc	a0,0x5
     898:	06450513          	addi	a0,a0,100 # 58f8 <malloc+0x3d0>
     89c:	3d5040ef          	jal	5470 <printf>
    exit(1);
     8a0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     8ae:	08650513          	addi	a0,a0,134 # 5930 <malloc+0x408>
     8b2:	3bf040ef          	jal	5470 <printf>
    exit(1);
     8b6:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     8c4:	09050513          	addi	a0,a0,144 # 5950 <malloc+0x428>
     8c8:	3a9040ef          	jal	5470 <printf>
    exit(1);
     8cc:	4505                	li	a0,1
...
00000000000008d2 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     8f2:	08250513          	addi	a0,a0,130 # 5970 <malloc+0x448>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     908:	094a0a13          	addi	s4,s4,148 # 5998 <malloc+0x470>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     90c:	00005b17          	auipc	s6,0x5
     910:	0c4b0b13          	addi	s6,s6,196 # 59d0 <malloc+0x4a8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     946:	02e50513          	addi	a0,a0,46 # 5970 <malloc+0x448>
  ...
  if(unlink("small") < 0){
     ...
     976:	ffe50513          	addi	a0,a0,-2 # 5970 <malloc+0x448>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     99e:	fde50513          	addi	a0,a0,-34 # 5978 <malloc+0x450>
     9a2:	2cf040ef          	jal	5470 <printf>
    exit(1);
     9a6:	4505                	li	a0,1
     ...
     9b4:	ff850513          	addi	a0,a0,-8 # 59a8 <malloc+0x480>
     9b8:	2b9040ef          	jal	5470 <printf>
      exit(1);
     9bc:	4505                	li	a0,1
     ...
     9ca:	01a50513          	addi	a0,a0,26 # 59e0 <malloc+0x4b8>
     9ce:	2a3040ef          	jal	5470 <printf>
      exit(1);
     9d2:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     9de:	02e50513          	addi	a0,a0,46 # 5a08 <malloc+0x4e0>
     9e2:	28f040ef          	jal	5470 <printf>
    exit(1);
     9e6:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9f2:	03a50513          	addi	a0,a0,58 # 5a28 <malloc+0x500>
     9f6:	27b040ef          	jal	5470 <printf>
    exit(1);
     9fa:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     a06:	03e50513          	addi	a0,a0,62 # 5a40 <malloc+0x518>
     a0a:	267040ef          	jal	5470 <printf>
    exit(1);
     a0e:	4505                	li	a0,1
...
0000000000000a14 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     a32:	03250513          	addi	a0,a0,50 # 5a60 <malloc+0x538>
  ...
  fd = open("big", O_RDONLY);
     ...
     a76:	fee50513          	addi	a0,a0,-18 # 5a60 <malloc+0x538>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     ab4:	fb850513          	addi	a0,a0,-72 # 5a68 <malloc+0x540>
     ab8:	1b9040ef          	jal	5470 <printf>
    exit(1);
     abc:	4505                	li	a0,1
     ...
     aca:	fc250513          	addi	a0,a0,-62 # 5a88 <malloc+0x560>
     ace:	1a3040ef          	jal	5470 <printf>
      exit(1);
     ad2:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     ade:	fd650513          	addi	a0,a0,-42 # 5ab0 <malloc+0x588>
     ae2:	18f040ef          	jal	5470 <printf>
    exit(1);
     ae6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     afe:	f6650513          	addi	a0,a0,-154 # 5a60 <malloc+0x538>
     ...
     b26:	fae50513          	addi	a0,a0,-82 # 5ad0 <malloc+0x5a8>
     b2a:	147040ef          	jal	5470 <printf>
        exit(1);
     b2e:	4505                	li	a0,1
     ...
     b3c:	fc050513          	addi	a0,a0,-64 # 5af8 <malloc+0x5d0>
     b40:	131040ef          	jal	5470 <printf>
      exit(1);
     b44:	4505                	li	a0,1
     ...
     b52:	fc250513          	addi	a0,a0,-62 # 5b10 <malloc+0x5e8>
     b56:	11b040ef          	jal	5470 <printf>
      exit(1);
     b5a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b66:	fd650513          	addi	a0,a0,-42 # 5b38 <malloc+0x610>
     b6a:	107040ef          	jal	5470 <printf>
    exit(1);
     b6e:	4505                	li	a0,1
...
0000000000000b74 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b8c:	fc850513          	addi	a0,a0,-56 # 5b50 <malloc+0x628>
  ...
  write(fd, "hello", SZ);
     ...
     ba0:	fe458593          	addi	a1,a1,-28 # 5b80 <malloc+0x658>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb4:	fa050513          	addi	a0,a0,-96 # 5b50 <malloc+0x628>
  ...
  unlink("unlinkread");
     ...
     c3c:	f1850513          	addi	a0,a0,-232 # 5b50 <malloc+0x628>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c58:	f0c50513          	addi	a0,a0,-244 # 5b60 <malloc+0x638>
     c5c:	015040ef          	jal	5470 <printf>
    exit(1);
     c60:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c6c:	f2050513          	addi	a0,a0,-224 # 5b88 <malloc+0x660>
     c70:	001040ef          	jal	5470 <printf>
    exit(1);
     c74:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c80:	f2c50513          	addi	a0,a0,-212 # 5ba8 <malloc+0x680>
     c84:	7ec040ef          	jal	5470 <printf>
    exit(1);
     c88:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c94:	f4050513          	addi	a0,a0,-192 # 5bd0 <malloc+0x6a8>
     c98:	7d8040ef          	jal	5470 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ca8:	f4c50513          	addi	a0,a0,-180 # 5bf0 <malloc+0x6c8>
     cac:	7c4040ef          	jal	5470 <printf>
    exit(1);
     cb0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cbc:	f5850513          	addi	a0,a0,-168 # 5c10 <malloc+0x6e8>
     cc0:	7b0040ef          	jal	5470 <printf>
    exit(1);
     cc4:	4505                	li	a0,1
...
0000000000000cca <linktest>:
{
  ...
  unlink("lf1");
     ...
     cdc:	f5850513          	addi	a0,a0,-168 # 5c30 <malloc+0x708>
     ce0:	35a040ef          	jal	503a <unlink>
  unlink("lf2");
     ce4:	00005517          	auipc	a0,0x5
     ce8:	f5450513          	addi	a0,a0,-172 # 5c38 <malloc+0x710>
     cec:	34e040ef          	jal	503a <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     cf0:	20200593          	li	a1,514
     cf4:	00005517          	auipc	a0,0x5
     cf8:	f3c50513          	addi	a0,a0,-196 # 5c30 <malloc+0x708>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d0c:	e7858593          	addi	a1,a1,-392 # 5b80 <malloc+0x658>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     de4:	e6050513          	addi	a0,a0,-416 # 5c40 <malloc+0x718>
     de8:	688040ef          	jal	5470 <printf>
    exit(1);
     dec:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     df8:	e6450513          	addi	a0,a0,-412 # 5c58 <malloc+0x730>
     dfc:	674040ef          	jal	5470 <printf>
    exit(1);
     e00:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     e0c:	e6850513          	addi	a0,a0,-408 # 5c70 <malloc+0x748>
     e10:	660040ef          	jal	5470 <printf>
    exit(1);
     e14:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     e20:	e7450513          	addi	a0,a0,-396 # 5c90 <malloc+0x768>
     e24:	64c040ef          	jal	5470 <printf>
    exit(1);
     e28:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     e34:	e9050513          	addi	a0,a0,-368 # 5cc0 <malloc+0x798>
     e38:	638040ef          	jal	5470 <printf>
    exit(1);
     e3c:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     e48:	e9450513          	addi	a0,a0,-364 # 5cd8 <malloc+0x7b0>
     e4c:	624040ef          	jal	5470 <printf>
    exit(1);
     e50:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e5c:	e9850513          	addi	a0,a0,-360 # 5cf0 <malloc+0x7c8>
     e60:	610040ef          	jal	5470 <printf>
    exit(1);
     e64:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e70:	eac50513          	addi	a0,a0,-340 # 5d18 <malloc+0x7f0>
     e74:	5fc040ef          	jal	5470 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e84:	ec850513          	addi	a0,a0,-312 # 5d48 <malloc+0x820>
     e88:	5e8040ef          	jal	5470 <printf>
    exit(1);
     e8c:	4505                	li	a0,1
...
0000000000000e92 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     eae:	ebe98993          	addi	s3,s3,-322 # 5d68 <malloc+0x840>
     eb2:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     eb4:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     ee6:	e9650513          	addi	a0,a0,-362 # 5d78 <malloc+0x850>
     eea:	586040ef          	jal	5470 <printf>
      exit(1);
     eee:	4505                	li	a0,1
...
0000000000000ef4 <bigdir>:
{
  ...
  unlink("bd");
     ...
     f10:	e8c50513          	addi	a0,a0,-372 # 5d98 <malloc+0x870>
     f14:	126040ef          	jal	503a <unlink>
  fd = open("bd", O_CREATE);
     f18:	20000593          	li	a1,512
     f1c:	00005517          	auipc	a0,0x5
     f20:	e7c50513          	addi	a0,a0,-388 # 5d98 <malloc+0x870>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     f3e:	e5e98993          	addi	s3,s3,-418 # 5d98 <malloc+0x870>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f8a:	e1250513          	addi	a0,a0,-494 # 5d98 <malloc+0x870>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     ff6:	dae50513          	addi	a0,a0,-594 # 5da0 <malloc+0x878>
     ffa:	476040ef          	jal	5470 <printf>
    exit(1);
     ffe:	4505                	li	a0,1
    ...
    1010:	db450513          	addi	a0,a0,-588 # 5dc0 <malloc+0x898>
    1014:	45c040ef          	jal	5470 <printf>
      exit(1);
    1018:	4505                	li	a0,1
    ...
    1024:	dc850513          	addi	a0,a0,-568 # 5de8 <malloc+0x8c0>
    1028:	448040ef          	jal	5470 <printf>
      exit(1);
    102c:	4505                	li	a0,1
...
000000000000105e <badarg>:
{
    ...
    1082:	5da98993          	addi	s3,s3,1498 # 5658 <malloc+0x130>
    argv[0] = (char*)0xffffffff;
...
00000000000010a0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    10f6:	e4678793          	addi	a5,a5,-442 # 6f38 <malloc+0x1a10>
  ...
  if(pid == 0){
    ...
    114a:	a5a78793          	addi	a5,a5,-1446 # 7ba0 <malloc+0x2678>
    ...
    116e:	4ee50513          	addi	a0,a0,1262 # 5658 <malloc+0x130>
    ...
    1182:	d1250513          	addi	a0,a0,-750 # 5e90 <malloc+0x968>
    1186:	2ea040ef          	jal	5470 <printf>
      exit(1);
    118a:	4505                	li	a0,1
    ...
    119a:	c7250513          	addi	a0,a0,-910 # 5e08 <malloc+0x8e0>
    119e:	2d2040ef          	jal	5470 <printf>
    exit(1);
    11a2:	4505                	li	a0,1
    ...
    11b2:	c7a50513          	addi	a0,a0,-902 # 5e28 <malloc+0x900>
    11b6:	2ba040ef          	jal	5470 <printf>
    exit(1);
    11ba:	4505                	li	a0,1
    ...
    11cc:	c8050513          	addi	a0,a0,-896 # 5e48 <malloc+0x920>
    11d0:	2a0040ef          	jal	5470 <printf>
    exit(1);
    11d4:	4505                	li	a0,1
    ...
    11e4:	c9050513          	addi	a0,a0,-880 # 5e70 <malloc+0x948>
    11e8:	288040ef          	jal	5470 <printf>
    exit(1);
    11ec:	4505                	li	a0,1
    11ee:	5fd030ef          	jal	4fea <exit>
    printf("fork failed\n");
    11f2:	00006517          	auipc	a0,0x6
    11f6:	29e50513          	addi	a0,a0,670 # 7490 <malloc+0x1f68>
    11fa:	276040ef          	jal	5470 <printf>
    exit(1);
    11fe:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1230:	c8c50513          	addi	a0,a0,-884 # 5eb8 <malloc+0x990>
    1234:	23c040ef          	jal	5470 <printf>
    exit(1);
    1238:	4505                	li	a0,1
...
000000000000123e <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    1252:	46250513          	addi	a0,a0,1122 # 56b0 <malloc+0x188>
  ...
  if(pid == 0){
    ...
    1282:	43298993          	addi	s3,s3,1074 # 56b0 <malloc+0x188>
      int n = write(fd, "1234567890", 10);
    1286:	4a29                	li	s4,10
    1288:	00005b17          	auipc	s6,0x5
    128c:	c90b0b13          	addi	s6,s6,-880 # 5f18 <malloc+0x9f0>
    ...
    12f2:	bfa50513          	addi	a0,a0,-1030 # 5ee8 <malloc+0x9c0>
    12f6:	17a040ef          	jal	5470 <printf>
    exit(1);
    12fa:	4505                	li	a0,1
    ...
    1306:	bfe50513          	addi	a0,a0,-1026 # 5f00 <malloc+0x9d8>
    130a:	166040ef          	jal	5470 <printf>
        exit(1);
    130e:	4505                	li	a0,1
    ...
    131c:	c1050513          	addi	a0,a0,-1008 # 5f28 <malloc+0xa00>
    1320:	150040ef          	jal	5470 <printf>
        exit(1);
    1324:	4505                	li	a0,1
    ...
    1342:	372a0a13          	addi	s4,s4,882 # 56b0 <malloc+0x188>
    int n = write(fd, "xxx", 3);
    1346:	498d                	li	s3,3
    1348:	00005b17          	auipc	s6,0x5
    134c:	c00b0b13          	addi	s6,s6,-1024 # 5f48 <malloc+0xa20>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    1350:	85d6                	mv	a1,s5
    1352:	8552                	mv	a0,s4
  ...
  unlink("truncfile");
    ...
    1386:	32e50513          	addi	a0,a0,814 # 56b0 <malloc+0x188>
  ...
  exit(xstatus);
    ...
    13a0:	b6450513          	addi	a0,a0,-1180 # 5f00 <malloc+0x9d8>
    13a4:	0cc040ef          	jal	5470 <printf>
      exit(1);
    13a8:	4505                	li	a0,1
    ...
    13ba:	b9a50513          	addi	a0,a0,-1126 # 5f50 <malloc+0xa28>
    13be:	0b2040ef          	jal	5470 <printf>
      exit(1);
    13c2:	4505                	li	a0,1
...
00000000000013c8 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    13d8:	28478793          	addi	a5,a5,644 # 5658 <malloc+0x130>
    13dc:	fcf43023          	sd	a5,-64(s0)
    13e0:	00005797          	auipc	a5,0x5
    13e4:	b9078793          	addi	a5,a5,-1136 # 5f70 <malloc+0xa48>
    13e8:	fcf43423          	sd	a5,-56(s0)
    13ec:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    13f0:	00005517          	auipc	a0,0x5
    13f4:	b8850513          	addi	a0,a0,-1144 # 5f78 <malloc+0xa50>
  ...
  if(pid == 0) {
    ...
    1418:	b6450513          	addi	a0,a0,-1180 # 5f78 <malloc+0xa50>
    ...
    1430:	b6c50513          	addi	a0,a0,-1172 # 5f98 <malloc+0xa70>
    1434:	03c040ef          	jal	5470 <printf>
      exit(1);
    1438:	4505                	li	a0,1
    ...
    1446:	aa650513          	addi	a0,a0,-1370 # 5ee8 <malloc+0x9c0>
    144a:	026040ef          	jal	5470 <printf>
     exit(1);
    144e:	4505                	li	a0,1
    ...
    145a:	b2a50513          	addi	a0,a0,-1238 # 5f80 <malloc+0xa58>
    145e:	012040ef          	jal	5470 <printf>
      exit(1);
    1462:	4505                	li	a0,1
    ...
    1470:	1ec50513          	addi	a0,a0,492 # 5658 <malloc+0x130>
  ...
  if(xstatus != 0)
    ...
    1498:	b1450513          	addi	a0,a0,-1260 # 5fa8 <malloc+0xa80>
    149c:	7d5030ef          	jal	5470 <printf>
      exit(1);
    14a0:	4505                	li	a0,1
    ...
    14ac:	b1850513          	addi	a0,a0,-1256 # 5fc0 <malloc+0xa98>
    14b0:	7c1030ef          	jal	5470 <printf>
    14b4:	bfd1                	j	1488 <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    14b6:	4581                	li	a1,0
    14b8:	00005517          	auipc	a0,0x5
    14bc:	ac050513          	addi	a0,a0,-1344 # 5f78 <malloc+0xa50>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    14de:	54e50513          	addi	a0,a0,1358 # 5a28 <malloc+0x500>
    14e2:	78f030ef          	jal	5470 <printf>
    exit(1);
    14e6:	4505                	li	a0,1
    ...
    14f2:	a1250513          	addi	a0,a0,-1518 # 5f00 <malloc+0x9d8>
    14f6:	77b030ef          	jal	5470 <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    14fc:	2ef030ef          	jal	4fea <exit>
  unlink("echo-ok");
    1500:	00005517          	auipc	a0,0x5
    1504:	a7850513          	addi	a0,a0,-1416 # 5f78 <malloc+0xa50>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    152a:	ab250513          	addi	a0,a0,-1358 # 5fd8 <malloc+0xab0>
    152e:	743030ef          	jal	5470 <printf>
    exit(1);
    1532:	4505                	li	a0,1
...
000000000000153e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    15d6:	a1e50513          	addi	a0,a0,-1506 # 5ff0 <malloc+0xac8>
    15da:	697030ef          	jal	5470 <printf>
    exit(1);
    15de:	4505                	li	a0,1
    ...
    1612:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0x65>
{
    ...
    1650:	9bc50513          	addi	a0,a0,-1604 # 6008 <malloc+0xae0>
    1654:	61d030ef          	jal	5470 <printf>
        exit(1);
    1658:	4505                	li	a0,1
    ...
    1664:	9c050513          	addi	a0,a0,-1600 # 6020 <malloc+0xaf8>
    1668:	609030ef          	jal	5470 <printf>
          return;
    ...
    1696:	9a650513          	addi	a0,a0,-1626 # 6038 <malloc+0xb10>
    169a:	5d7030ef          	jal	5470 <printf>
      exit(1);
    169e:	4505                	li	a0,1
    ...
    16d2:	98a50513          	addi	a0,a0,-1654 # 6058 <malloc+0xb30>
    16d6:	59b030ef          	jal	5470 <printf>
    exit(1);
    16da:	4505                	li	a0,1
...
00000000000016e0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    173a:	7b250513          	addi	a0,a0,1970 # 5ee8 <malloc+0x9c0>
    173e:	533030ef          	jal	5470 <printf>
      exit(1);
    1742:	4505                	li	a0,1
    ...
    174e:	92650513          	addi	a0,a0,-1754 # 6070 <malloc+0xb48>
    1752:	51f030ef          	jal	5470 <printf>
        exit(1);
    1756:	4505                	li	a0,1
    ...
    1762:	92a50513          	addi	a0,a0,-1750 # 6088 <malloc+0xb60>
    1766:	50b030ef          	jal	5470 <printf>
        exit(1);
    176a:	4505                	li	a0,1
...
0000000000001776 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    17be:	72e50513          	addi	a0,a0,1838 # 5ee8 <malloc+0x9c0>
    17c2:	4af030ef          	jal	5470 <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    ...
    17d6:	71650513          	addi	a0,a0,1814 # 5ee8 <malloc+0x9c0>
    17da:	497030ef          	jal	5470 <printf>
        exit(1);
    17de:	4505                	li	a0,1
...
00000000000017e8 <forkfork>:
{
    ...
    1834:	87850513          	addi	a0,a0,-1928 # 60a8 <malloc+0xb80>
    1838:	439030ef          	jal	5470 <printf>
      exit(1);
    183c:	4505                	li	a0,1
    183e:	7ac030ef          	jal	4fea <exit>
{
    ...
    1870:	84c50513          	addi	a0,a0,-1972 # 60b8 <malloc+0xb90>
    1874:	3fd030ef          	jal	5470 <printf>
      exit(1);
    1878:	4505                	li	a0,1
...
000000000000187e <reparent2>:
{
  ...
  exit(0);
    ...
    18aa:	bea50513          	addi	a0,a0,-1046 # 7490 <malloc+0x1f68>
    18ae:	3c3030ef          	jal	5470 <printf>
      exit(1);
    18b2:	4505                	li	a0,1
...
00000000000018c6 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1936:	5b650513          	addi	a0,a0,1462 # 5ee8 <malloc+0x9c0>
    193a:	337030ef          	jal	5470 <printf>
      exit(1);
    193e:	4505                	li	a0,1
    ...
    1962:	62250513          	addi	a0,a0,1570 # 5f80 <malloc+0xa58>
    1966:	30b030ef          	jal	5470 <printf>
          exit(1);
    196a:	4505                	li	a0,1
    ...
    19c2:	71a50513          	addi	a0,a0,1818 # 60d8 <malloc+0xbb0>
    19c6:	2ab030ef          	jal	5470 <printf>
            exit(1);
    19ca:	4505                	li	a0,1
    ...
    1a0c:	6e850513          	addi	a0,a0,1768 # 60f0 <malloc+0xbc8>
    1a10:	261030ef          	jal	5470 <printf>
        exit(1);
    1a14:	4505                	li	a0,1
    ...
    1a28:	6f450513          	addi	a0,a0,1780 # 6118 <malloc+0xbf0>
    1a2c:	245030ef          	jal	5470 <printf>
        exit(1);
    1a30:	4505                	li	a0,1
...
0000000000001ab2 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1ad4:	bf850513          	addi	a0,a0,-1032 # 56c8 <malloc+0x1a0>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b14:	bb8b0b13          	addi	s6,s6,-1096 # 56c8 <malloc+0x1a0>
      link("cat", "x");
    1b18:	00004c97          	auipc	s9,0x4
    1b1c:	628c8c93          	addi	s9,s9,1576 # 6140 <malloc+0xc18>
    ...
    1b2c:	3c050513          	addi	a0,a0,960 # 5ee8 <malloc+0x9c0>
    1b30:	141030ef          	jal	5470 <printf>
    exit(1);
    1b34:	4505                	li	a0,1
...
0000000000001bac <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1bd8:	5bc50513          	addi	a0,a0,1468 # 6190 <malloc+0xc68>
    1bdc:	095030ef          	jal	5470 <printf>
    exit(1);
    1be0:	4505                	li	a0,1
    ...
    1bf0:	55c50513          	addi	a0,a0,1372 # 6148 <malloc+0xc20>
    1bf4:	07d030ef          	jal	5470 <printf>
    exit(1);
    1bf8:	4505                	li	a0,1
    ...
    1c04:	56050513          	addi	a0,a0,1376 # 6160 <malloc+0xc38>
    1c08:	069030ef          	jal	5470 <printf>
      exit(1);
    1c0c:	4505                	li	a0,1
    ...
    1c18:	56450513          	addi	a0,a0,1380 # 6178 <malloc+0xc50>
    1c1c:	055030ef          	jal	5470 <printf>
    exit(1);
    1c20:	4505                	li	a0,1
...
0000000000001c54 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1cbc:	23050513          	addi	a0,a0,560 # 5ee8 <malloc+0x9c0>
    1cc0:	7b0030ef          	jal	5470 <printf>
      exit(1);
    1cc4:	4505                	li	a0,1
    ...
    1cd6:	4e650513          	addi	a0,a0,1254 # 61b8 <malloc+0xc90>
    1cda:	796030ef          	jal	5470 <printf>
      exit(1);
    1cde:	4505                	li	a0,1
...
0000000000001cea <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1d4a:	1a250513          	addi	a0,a0,418 # 5ee8 <malloc+0x9c0>
    1d4e:	722030ef          	jal	5470 <printf>
      exit(1);
    1d52:	4505                	li	a0,1
    ...
    1d6e:	46e50513          	addi	a0,a0,1134 # 61d8 <malloc+0xcb0>
    1d72:	6fe030ef          	jal	5470 <printf>
      exit(1);
    1d76:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1dbe:	43650513          	addi	a0,a0,1078 # 61f0 <malloc+0xcc8>
    1dc2:	6ae030ef          	jal	5470 <printf>
    exit(1);
    1dc6:	4505                	li	a0,1
    ...
    1dd2:	11a50513          	addi	a0,a0,282 # 5ee8 <malloc+0x9c0>
    1dd6:	69a030ef          	jal	5470 <printf>
    exit(1);
    1dda:	4505                	li	a0,1
...
0000000000001de6 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1dfc:	da878793          	addi	a5,a5,-600 # 7ba0 <malloc+0x2678>
  ...
  exit(0);
    ...
    1e66:	3b650513          	addi	a0,a0,950 # 6218 <malloc+0xcf0>
    1e6a:	606030ef          	jal	5470 <printf>
      exit(0);
    1e6e:	4501                	li	a0,0
    ...
    1e7a:	07250513          	addi	a0,a0,114 # 5ee8 <malloc+0x9c0>
    1e7e:	5f2030ef          	jal	5470 <printf>
      exit(1);
    1e82:	4505                	li	a0,1
...
0000000000001e8e <manywrites>:
{
  ...
  exit(0);
    ...
    1ef2:	5a250513          	addi	a0,a0,1442 # 7490 <malloc+0x1f68>
    1ef6:	57a030ef          	jal	5470 <printf>
      exit(1);
    1efa:	4505                	li	a0,1
    ...
    1f92:	2aa50513          	addi	a0,a0,682 # 6238 <malloc+0xd10>
    1f96:	4da030ef          	jal	5470 <printf>
            exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	78250513          	addi	a0,a0,1922 # 5728 <malloc+0x200>
    1fae:	4c2030ef          	jal	5470 <printf>
            exit(1);
    1fb2:	4505                	li	a0,1
...
0000000000001fc8 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    202a:	f1278793          	addi	a5,a5,-238 # 6f38 <malloc+0x1a10>
  ...
  if(ret != -1){
    ...
    2064:	1f050513          	addi	a0,a0,496 # 6250 <malloc+0xd28>
    2068:	408030ef          	jal	5470 <printf>
    exit(1);
    206c:	4505                	li	a0,1
    ...
    207a:	d9250513          	addi	a0,a0,-622 # 5e08 <malloc+0x8e0>
    207e:	3f2030ef          	jal	5470 <printf>
    exit(1);
    2082:	4505                	li	a0,1
    ...
    2090:	d9c50513          	addi	a0,a0,-612 # 5e28 <malloc+0x900>
    2094:	3dc030ef          	jal	5470 <printf>
    exit(1);
    2098:	4505                	li	a0,1
    ...
    20a8:	da450513          	addi	a0,a0,-604 # 5e48 <malloc+0x920>
    20ac:	3c4030ef          	jal	5470 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    ...
    20be:	db650513          	addi	a0,a0,-586 # 5e70 <malloc+0x948>
    20c2:	3ae030ef          	jal	5470 <printf>
    exit(1);
    20c6:	4505                	li	a0,1
...
00000000000020cc <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    20fa:	19a50513          	addi	a0,a0,410 # 6290 <malloc+0xd68>
  ...
  if(n >= 0){
    ...
    2122:	19250513          	addi	a0,a0,402 # 62b0 <malloc+0xd88>
    2126:	34a030ef          	jal	5470 <printf>
    exit(1);
    212a:	4505                	li	a0,1
    ...
    2138:	12450513          	addi	a0,a0,292 # 6258 <malloc+0xd30>
    213c:	334030ef          	jal	5470 <printf>
    exit(1);
    2140:	4505                	li	a0,1
    ...
    214c:	12850513          	addi	a0,a0,296 # 6270 <malloc+0xd48>
    2150:	320030ef          	jal	5470 <printf>
    exit(1);
    2154:	4505                	li	a0,1
    2156:	695020ef          	jal	4fea <exit>
    printf("open(rwsbrk) failed\n");
    215a:	00004517          	auipc	a0,0x4
    215e:	13e50513          	addi	a0,a0,318 # 6298 <malloc+0xd70>
    2162:	30e030ef          	jal	5470 <printf>
    exit(1);
    2166:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2176:	11e50513          	addi	a0,a0,286 # 6290 <malloc+0xd68>
    217a:	6c1020ef          	jal	503a <unlink>
  fd = open("README", O_RDONLY);
    217e:	4581                	li	a1,0
    2180:	00003517          	auipc	a0,0x3
    2184:	6b050513          	addi	a0,a0,1712 # 5830 <malloc+0x308>
  ...
  if(n >= 0){
    ...
    21a6:	13e50513          	addi	a0,a0,318 # 62e0 <malloc+0xdb8>
    21aa:	2c6030ef          	jal	5470 <printf>
    exit(1);
    21ae:	4505                	li	a0,1
    21b0:	63b020ef          	jal	4fea <exit>
    printf("open(README) failed\n");
    21b4:	00003517          	auipc	a0,0x3
    21b8:	68450513          	addi	a0,a0,1668 # 5838 <malloc+0x310>
    21bc:	2b4030ef          	jal	5470 <printf>
    exit(1);
    21c0:	4505                	li	a0,1
...
00000000000021d2 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2226:	0e650513          	addi	a0,a0,230 # 6308 <malloc+0xde0>
    222a:	246030ef          	jal	5470 <printf>
    exit(1);
    222e:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    227e:	0ae50513          	addi	a0,a0,174 # 6328 <malloc+0xe00>
    2282:	1ee030ef          	jal	5470 <printf>
    exit(1);
    2286:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    22c8:	0c450513          	addi	a0,a0,196 # 6388 <malloc+0xe60>
    22cc:	1a4030ef          	jal	5470 <printf>
    exit(1);
    22d0:	4505                	li	a0,1
    ...
    22e2:	06a50513          	addi	a0,a0,106 # 6348 <malloc+0xe20>
    22e6:	18a030ef          	jal	5470 <printf>
      exit(1);
    22ea:	4505                	li	a0,1
    ...
    22f6:	07650513          	addi	a0,a0,118 # 6368 <malloc+0xe40>
    22fa:	176030ef          	jal	5470 <printf>
    exit(1);
    22fe:	4505                	li	a0,1
...
000000000000231e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    23e2:	fca50513          	addi	a0,a0,-54 # 63a8 <malloc+0xe80>
    23e6:	08a030ef          	jal	5470 <printf>
    exit(1);
    23ea:	4505                	li	a0,1
    ...
    23f6:	ffe50513          	addi	a0,a0,-2 # 63f0 <malloc+0xec8>
    23fa:	076030ef          	jal	5470 <printf>
    exit(1);
    23fe:	4505                	li	a0,1
    ...
    240e:	00650513          	addi	a0,a0,6 # 6410 <malloc+0xee8>
    2412:	05e030ef          	jal	5470 <printf>
    exit(1);
    2416:	4505                	li	a0,1
    ...
    2426:	02e50513          	addi	a0,a0,46 # 6450 <malloc+0xf28>
    242a:	046030ef          	jal	5470 <printf>
    exit(1);
    242e:	4505                	li	a0,1
    ...
    243a:	04a50513          	addi	a0,a0,74 # 6480 <malloc+0xf58>
    243e:	032030ef          	jal	5470 <printf>
    exit(1);
    2442:	4505                	li	a0,1
    ...
    2452:	06a50513          	addi	a0,a0,106 # 64b8 <malloc+0xf90>
    2456:	01a030ef          	jal	5470 <printf>
    exit(1);
    245a:	4505                	li	a0,1
...
0000000000002460 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2480:	06450513          	addi	a0,a0,100 # 64e0 <malloc+0xfb8>
    2484:	3a7020ef          	jal	502a <open>
    2488:	84aa                	mv	s1,a0
  unlink("sbrk");
    248a:	00004517          	auipc	a0,0x4
    248e:	05650513          	addi	a0,a0,86 # 64e0 <malloc+0xfb8>
  ...
  if(pipe((int *) a) != 0){
    ...
    24ce:	01e50513          	addi	a0,a0,30 # 64e8 <malloc+0xfc0>
    24d2:	79f020ef          	jal	5470 <printf>
    exit(1);
    24d6:	4505                	li	a0,1
    ...
    24e2:	02250513          	addi	a0,a0,34 # 6500 <malloc+0xfd8>
    24e6:	78b020ef          	jal	5470 <printf>
    exit(1);
    24ea:	4505                	li	a0,1
    ...
    24f6:	afe50513          	addi	a0,a0,-1282 # 5ff0 <malloc+0xac8>
    24fa:	777020ef          	jal	5470 <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002504 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2518:	00450513          	addi	a0,a0,4 # 6518 <malloc+0xff0>
  ...
  close(fd);
    ...
    2550:	9b450513          	addi	a0,a0,-1612 # 5f00 <malloc+0x9d8>
    2554:	71d020ef          	jal	5470 <printf>
    exit(1);
    2558:	4505                	li	a0,1
...
000000000000255e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2586:	f0e50513          	addi	a0,a0,-242 # 7490 <malloc+0x1f68>
    258a:	6e7020ef          	jal	5470 <printf>
    exit(1);
    258e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    25c0:	ed450513          	addi	a0,a0,-300 # 7490 <malloc+0x1f68>
    25c4:	6ad020ef          	jal	5470 <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2600:	e9450513          	addi	a0,a0,-364 # 7490 <malloc+0x1f68>
    2604:	66d020ef          	jal	5470 <printf>
    exit(1);
    2608:	4505                	li	a0,1
...
00000000000026ea <execout>:
{
  ...
  exit(0);
    ...
    2726:	d6e50513          	addi	a0,a0,-658 # 7490 <malloc+0x1f68>
    272a:	547020ef          	jal	5470 <printf>
      exit(1);
    272e:	4505                	li	a0,1
...
000000000000279a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27ca:	dda50513          	addi	a0,a0,-550 # 65a0 <malloc+0x1078>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27e0:	e3c50513          	addi	a0,a0,-452 # 6618 <malloc+0x10f0>
  ...
  unlink("12345678901234");
    ...
    2864:	cc050513          	addi	a0,a0,-832 # 6520 <malloc+0xff8>
    2868:	409020ef          	jal	5470 <printf>
    exit(1);
    286c:	4505                	li	a0,1
    ...
    2878:	cf450513          	addi	a0,a0,-780 # 6568 <malloc+0x1040>
    287c:	3f5020ef          	jal	5470 <printf>
    exit(1);
    2880:	4505                	li	a0,1
    ...
    288c:	d4850513          	addi	a0,a0,-696 # 65d0 <malloc+0x10a8>
    2890:	3e1020ef          	jal	5470 <printf>
    exit(1);
    2894:	4505                	li	a0,1
    ...
    28a0:	dac50513          	addi	a0,a0,-596 # 6648 <malloc+0x1120>
    28a4:	3cd020ef          	jal	5470 <printf>
    exit(1);
    28a8:	4505                	li	a0,1
    ...
    28b4:	df850513          	addi	a0,a0,-520 # 66a8 <malloc+0x1180>
    28b8:	3b9020ef          	jal	5470 <printf>
    exit(1);
    28bc:	4505                	li	a0,1
    ...
    28c8:	e3c50513          	addi	a0,a0,-452 # 6700 <malloc+0x11d8>
    28cc:	3a5020ef          	jal	5470 <printf>
    exit(1);
    28d0:	4505                	li	a0,1
...
00000000000028d6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    291a:	e2250513          	addi	a0,a0,-478 # 6738 <malloc+0x1210>
    ...
    2950:	dfc50513          	addi	a0,a0,-516 # 6748 <malloc+0x1220>
    2954:	31d020ef          	jal	5470 <printf>
      break;
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2afe:	c6e50513          	addi	a0,a0,-914 # 6768 <malloc+0x1240>
    2b02:	16f020ef          	jal	5470 <printf>
...
0000000000002b08 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2b64:	c4050513          	addi	a0,a0,-960 # 67a0 <malloc+0x1278>
    2b68:	109020ef          	jal	5470 <printf>
    exit(1);
    2b6c:	4505                	li	a0,1
    ...
    2b78:	c4450513          	addi	a0,a0,-956 # 67b8 <malloc+0x1290>
    2b7c:	0f5020ef          	jal	5470 <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	c6050513          	addi	a0,a0,-928 # 67e8 <malloc+0x12c0>
    2b90:	0e1020ef          	jal	5470 <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	c7450513          	addi	a0,a0,-908 # 6810 <malloc+0x12e8>
    2ba4:	0cd020ef          	jal	5470 <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
...
0000000000002bae <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c00:	2ec50513          	addi	a0,a0,748 # 5ee8 <malloc+0x9c0>
    2c04:	06d020ef          	jal	5470 <printf>
    exit(1);
    2c08:	4505                	li	a0,1
    ...
    2c14:	b9050513          	addi	a0,a0,-1136 # 67a0 <malloc+0x1278>
    2c18:	059020ef          	jal	5470 <printf>
      exit(1);
    2c1c:	4505                	li	a0,1
    ...
    2c28:	c0450513          	addi	a0,a0,-1020 # 6828 <malloc+0x1300>
    2c2c:	045020ef          	jal	5470 <printf>
      exit(1);
    2c30:	4505                	li	a0,1
    ...
    2c3c:	bb050513          	addi	a0,a0,-1104 # 67e8 <malloc+0x12c0>
    2c40:	031020ef          	jal	5470 <printf>
      exit(1);
    2c44:	4505                	li	a0,1
...
0000000000002c5a <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2cb6:	aee50513          	addi	a0,a0,-1298 # 67a0 <malloc+0x1278>
    2cba:	7b6020ef          	jal	5470 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
    ...
    2cca:	b8250513          	addi	a0,a0,-1150 # 6848 <malloc+0x1320>
    2cce:	7a2020ef          	jal	5470 <printf>
    exit(1);
    2cd2:	4505                	li	a0,1
    ...
    2cde:	b8e50513          	addi	a0,a0,-1138 # 6868 <malloc+0x1340>
    2ce2:	78e020ef          	jal	5470 <printf>
    exit(1);
    2ce6:	4505                	li	a0,1
    ...
    2cf2:	b9250513          	addi	a0,a0,-1134 # 6880 <malloc+0x1358>
    2cf6:	77a020ef          	jal	5470 <printf>
    exit(1);
    2cfa:	4505                	li	a0,1
...
0000000000002d00 <subdir>:
{
  ...
  unlink("ff");
    ...
    2d12:	cba50513          	addi	a0,a0,-838 # 69c8 <malloc+0x14a0>
    2d16:	324020ef          	jal	503a <unlink>
  if(mkdir("dd") != 0){
    2d1a:	00004517          	auipc	a0,0x4
    2d1e:	b7e50513          	addi	a0,a0,-1154 # 6898 <malloc+0x1370>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d32:	b8a50513          	addi	a0,a0,-1142 # 68b8 <malloc+0x1390>
  ...
  write(fd, "ff", 2);
    ...
    2d46:	c8658593          	addi	a1,a1,-890 # 69c8 <malloc+0x14a0>
  ...
  if(unlink("dd") >= 0){
    ...
    2d58:	b4450513          	addi	a0,a0,-1212 # 6898 <malloc+0x1370>
    2d5c:	2de020ef          	jal	503a <unlink>
    2d60:	2c055963          	bgez	a0,3032 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2d64:	00004517          	auipc	a0,0x4
    2d68:	bac50513          	addi	a0,a0,-1108 # 6910 <malloc+0x13e8>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d7c:	bc050513          	addi	a0,a0,-1088 # 6938 <malloc+0x1410>
  ...
  write(fd, "FF", 2);
    ...
    2d90:	bdc58593          	addi	a1,a1,-1060 # 6968 <malloc+0x1440>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da4:	bd050513          	addi	a0,a0,-1072 # 6970 <malloc+0x1448>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e8a:	ab250513          	addi	a0,a0,-1358 # 6938 <malloc+0x1410>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2e9e:	cb650513          	addi	a0,a0,-842 # 6b50 <malloc+0x1628>
  ...
  if(unlink("dd") < 0){
    ...
    3010:	89450513          	addi	a0,a0,-1900 # 68a0 <malloc+0x1378>
    3014:	45c020ef          	jal	5470 <printf>
    exit(1);
    3018:	4505                	li	a0,1
    ...
    3024:	8a050513          	addi	a0,a0,-1888 # 68c0 <malloc+0x1398>
    3028:	448020ef          	jal	5470 <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    3038:	8ac50513          	addi	a0,a0,-1876 # 68e0 <malloc+0x13b8>
    303c:	434020ef          	jal	5470 <printf>
    exit(1);
    3040:	4505                	li	a0,1
    ...
    304c:	8d050513          	addi	a0,a0,-1840 # 6918 <malloc+0x13f0>
    3050:	420020ef          	jal	5470 <printf>
    exit(1);
    3054:	4505                	li	a0,1
    ...
    3060:	8ec50513          	addi	a0,a0,-1812 # 6948 <malloc+0x1420>
    3064:	40c020ef          	jal	5470 <printf>
    exit(1);
    3068:	4505                	li	a0,1
    ...
    3074:	91050513          	addi	a0,a0,-1776 # 6980 <malloc+0x1458>
    3078:	3f8020ef          	jal	5470 <printf>
    exit(1);
    307c:	4505                	li	a0,1
    ...
    3088:	91c50513          	addi	a0,a0,-1764 # 69a0 <malloc+0x1478>
    308c:	3e4020ef          	jal	5470 <printf>
    exit(1);
    3090:	4505                	li	a0,1
    ...
    309c:	93850513          	addi	a0,a0,-1736 # 69d0 <malloc+0x14a8>
    30a0:	3d0020ef          	jal	5470 <printf>
    exit(1);
    30a4:	4505                	li	a0,1
    ...
    30b0:	94c50513          	addi	a0,a0,-1716 # 69f8 <malloc+0x14d0>
    30b4:	3bc020ef          	jal	5470 <printf>
    exit(1);
    30b8:	4505                	li	a0,1
    ...
    30c4:	95850513          	addi	a0,a0,-1704 # 6a18 <malloc+0x14f0>
    30c8:	3a8020ef          	jal	5470 <printf>
    exit(1);
    30cc:	4505                	li	a0,1
    ...
    30d8:	96c50513          	addi	a0,a0,-1684 # 6a40 <malloc+0x1518>
    30dc:	394020ef          	jal	5470 <printf>
    exit(1);
    30e0:	4505                	li	a0,1
    ...
    30ec:	98050513          	addi	a0,a0,-1664 # 6a68 <malloc+0x1540>
    30f0:	380020ef          	jal	5470 <printf>
    exit(1);
    30f4:	4505                	li	a0,1
    ...
    3100:	99c50513          	addi	a0,a0,-1636 # 6a98 <malloc+0x1570>
    3104:	36c020ef          	jal	5470 <printf>
    exit(1);
    3108:	4505                	li	a0,1
    ...
    3114:	9b850513          	addi	a0,a0,-1608 # 6ac8 <malloc+0x15a0>
    3118:	358020ef          	jal	5470 <printf>
    exit(1);
    311c:	4505                	li	a0,1
    ...
    3128:	9bc50513          	addi	a0,a0,-1604 # 6ae0 <malloc+0x15b8>
    312c:	344020ef          	jal	5470 <printf>
    exit(1);
    3130:	4505                	li	a0,1
    ...
    313c:	9c850513          	addi	a0,a0,-1592 # 6b00 <malloc+0x15d8>
    3140:	330020ef          	jal	5470 <printf>
    exit(1);
    3144:	4505                	li	a0,1
    ...
    3150:	9d450513          	addi	a0,a0,-1580 # 6b20 <malloc+0x15f8>
    3154:	31c020ef          	jal	5470 <printf>
    exit(1);
    3158:	4505                	li	a0,1
    ...
    3164:	a0050513          	addi	a0,a0,-1536 # 6b60 <malloc+0x1638>
    3168:	308020ef          	jal	5470 <printf>
    exit(1);
    316c:	4505                	li	a0,1
    ...
    3178:	a1c50513          	addi	a0,a0,-1508 # 6b90 <malloc+0x1668>
    317c:	2f4020ef          	jal	5470 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    318c:	a2850513          	addi	a0,a0,-1496 # 6bb0 <malloc+0x1688>
    3190:	2e0020ef          	jal	5470 <printf>
    exit(1);
    3194:	4505                	li	a0,1
    ...
    31a0:	a3450513          	addi	a0,a0,-1484 # 6bd0 <malloc+0x16a8>
    31a4:	2cc020ef          	jal	5470 <printf>
    exit(1);
    31a8:	4505                	li	a0,1
    ...
    31b4:	a4050513          	addi	a0,a0,-1472 # 6bf0 <malloc+0x16c8>
    31b8:	2b8020ef          	jal	5470 <printf>
    exit(1);
    31bc:	4505                	li	a0,1
    ...
    31c8:	a5c50513          	addi	a0,a0,-1444 # 6c20 <malloc+0x16f8>
    31cc:	2a4020ef          	jal	5470 <printf>
    exit(1);
    31d0:	4505                	li	a0,1
    ...
    31dc:	a7050513          	addi	a0,a0,-1424 # 6c48 <malloc+0x1720>
    31e0:	290020ef          	jal	5470 <printf>
    exit(1);
    31e4:	4505                	li	a0,1
    ...
    31f0:	a8450513          	addi	a0,a0,-1404 # 6c70 <malloc+0x1748>
    31f4:	27c020ef          	jal	5470 <printf>
    exit(1);
    31f8:	4505                	li	a0,1
    ...
    3204:	a9850513          	addi	a0,a0,-1384 # 6c98 <malloc+0x1770>
    3208:	268020ef          	jal	5470 <printf>
    exit(1);
    320c:	4505                	li	a0,1
    ...
    3218:	aa450513          	addi	a0,a0,-1372 # 6cb8 <malloc+0x1790>
    321c:	254020ef          	jal	5470 <printf>
    exit(1);
    3220:	4505                	li	a0,1
    ...
    322c:	ab050513          	addi	a0,a0,-1360 # 6cd8 <malloc+0x17b0>
    3230:	240020ef          	jal	5470 <printf>
    exit(1);
    3234:	4505                	li	a0,1
    ...
    3240:	ac450513          	addi	a0,a0,-1340 # 6d00 <malloc+0x17d8>
    3244:	22c020ef          	jal	5470 <printf>
    exit(1);
    3248:	4505                	li	a0,1
    ...
    3254:	ad050513          	addi	a0,a0,-1328 # 6d20 <malloc+0x17f8>
    3258:	218020ef          	jal	5470 <printf>
    exit(1);
    325c:	4505                	li	a0,1
    ...
    3268:	adc50513          	addi	a0,a0,-1316 # 6d40 <malloc+0x1818>
    326c:	204020ef          	jal	5470 <printf>
    exit(1);
    3270:	4505                	li	a0,1
    ...
    327c:	af050513          	addi	a0,a0,-1296 # 6d68 <malloc+0x1840>
    3280:	1f0020ef          	jal	5470 <printf>
    exit(1);
    3284:	4505                	li	a0,1
    ...
    3290:	76c50513          	addi	a0,a0,1900 # 69f8 <malloc+0x14d0>
    3294:	1dc020ef          	jal	5470 <printf>
    exit(1);
    3298:	4505                	li	a0,1
    ...
    32a4:	ae850513          	addi	a0,a0,-1304 # 6d88 <malloc+0x1860>
    32a8:	1c8020ef          	jal	5470 <printf>
    exit(1);
    32ac:	4505                	li	a0,1
    ...
    32b8:	af450513          	addi	a0,a0,-1292 # 6da8 <malloc+0x1880>
    32bc:	1b4020ef          	jal	5470 <printf>
    exit(1);
    32c0:	4505                	li	a0,1
    ...
    32cc:	b1050513          	addi	a0,a0,-1264 # 6dd8 <malloc+0x18b0>
    32d0:	1a0020ef          	jal	5470 <printf>
    exit(1);
    32d4:	4505                	li	a0,1
    ...
    32e0:	b1c50513          	addi	a0,a0,-1252 # 6df8 <malloc+0x18d0>
    32e4:	18c020ef          	jal	5470 <printf>
    exit(1);
    32e8:	4505                	li	a0,1
...
00000000000032ee <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    337a:	aa250513          	addi	a0,a0,-1374 # 6e18 <malloc+0x18f0>
    337e:	0f2020ef          	jal	5470 <printf>
    exit(1);
    3382:	4505                	li	a0,1
    ...
    338e:	aa650513          	addi	a0,a0,-1370 # 6e30 <malloc+0x1908>
    3392:	0de020ef          	jal	5470 <printf>
    exit(1);
    3396:	4505                	li	a0,1
    ...
    33a2:	aaa50513          	addi	a0,a0,-1366 # 6e48 <malloc+0x1920>
    33a6:	0ca020ef          	jal	5470 <printf>
    exit(1);
    33aa:	4505                	li	a0,1
    ...
    33b6:	aae50513          	addi	a0,a0,-1362 # 6e60 <malloc+0x1938>
    33ba:	0b6020ef          	jal	5470 <printf>
    exit(1);
    33be:	4505                	li	a0,1
    ...
    33ca:	44a50513          	addi	a0,a0,1098 # 6810 <malloc+0x12e8>
    33ce:	0a2020ef          	jal	5470 <printf>
    exit(1);
    33d2:	4505                	li	a0,1
    ...
    33de:	aa650513          	addi	a0,a0,-1370 # 6e80 <malloc+0x1958>
    33e2:	08e020ef          	jal	5470 <printf>
    exit(1);
    33e6:	4505                	li	a0,1
    ...
    33f2:	aba50513          	addi	a0,a0,-1350 # 6ea8 <malloc+0x1980>
    33f6:	07a020ef          	jal	5470 <printf>
    exit(1);
    33fa:	4505                	li	a0,1
    ...
    3406:	ac650513          	addi	a0,a0,-1338 # 6ec8 <malloc+0x19a0>
    340a:	066020ef          	jal	5470 <printf>
    exit(1);
    340e:	4505                	li	a0,1
...
0000000000003414 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    342a:	ac250513          	addi	a0,a0,-1342 # 6ee8 <malloc+0x19c0>
  ...
  if(chdir("dirfile") == 0){
    ...
    343e:	aae50513          	addi	a0,a0,-1362 # 6ee8 <malloc+0x19c0>
    3442:	419010ef          	jal	505a <chdir>
    3446:	c569                	beqz	a0,3510 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3448:	4581                	li	a1,0
    344a:	00004517          	auipc	a0,0x4
    344e:	ae650513          	addi	a0,a0,-1306 # 6f30 <malloc+0x1a08>
  ...
  fd = open(".", 0);
    ...
    34ce:	87650513          	addi	a0,a0,-1930 # 5d40 <malloc+0x818>
    34d2:	359010ef          	jal	502a <open>
    34d6:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    34d8:	4605                	li	a2,1
    34da:	00002597          	auipc	a1,0x2
    34de:	1ee58593          	addi	a1,a1,494 # 56c8 <malloc+0x1a0>
  ...
  close(fd);
    ...
    3502:	9f250513          	addi	a0,a0,-1550 # 6ef0 <malloc+0x19c8>
    3506:	76b010ef          	jal	5470 <printf>
    exit(1);
    350a:	4505                	li	a0,1
    ...
    3516:	9fe50513          	addi	a0,a0,-1538 # 6f10 <malloc+0x19e8>
    351a:	757010ef          	jal	5470 <printf>
    exit(1);
    351e:	4505                	li	a0,1
    ...
    352a:	a1a50513          	addi	a0,a0,-1510 # 6f40 <malloc+0x1a18>
    352e:	743010ef          	jal	5470 <printf>
    exit(1);
    3532:	4505                	li	a0,1
    ...
    353e:	a0650513          	addi	a0,a0,-1530 # 6f40 <malloc+0x1a18>
    3542:	72f010ef          	jal	5470 <printf>
    exit(1);
    3546:	4505                	li	a0,1
    ...
    3552:	a1a50513          	addi	a0,a0,-1510 # 6f68 <malloc+0x1a40>
    3556:	71b010ef          	jal	5470 <printf>
    exit(1);
    355a:	4505                	li	a0,1
    ...
    3566:	a2e50513          	addi	a0,a0,-1490 # 6f90 <malloc+0x1a68>
    356a:	707010ef          	jal	5470 <printf>
    exit(1);
    356e:	4505                	li	a0,1
    ...
    357a:	a4250513          	addi	a0,a0,-1470 # 6fb8 <malloc+0x1a90>
    357e:	6f3010ef          	jal	5470 <printf>
    exit(1);
    3582:	4505                	li	a0,1
    ...
    358e:	a5650513          	addi	a0,a0,-1450 # 6fe0 <malloc+0x1ab8>
    3592:	6df010ef          	jal	5470 <printf>
    exit(1);
    3596:	4505                	li	a0,1
    ...
    35a2:	a6250513          	addi	a0,a0,-1438 # 7000 <malloc+0x1ad8>
    35a6:	6cb010ef          	jal	5470 <printf>
    exit(1);
    35aa:	4505                	li	a0,1
    ...
    35b6:	a7650513          	addi	a0,a0,-1418 # 7028 <malloc+0x1b00>
    35ba:	6b7010ef          	jal	5470 <printf>
    exit(1);
    35be:	4505                	li	a0,1
...
00000000000035c4 <iref>:
{
    ...
    35e4:	a60a8a93          	addi	s5,s5,-1440 # 7040 <malloc+0x1b18>
    mkdir("");
    35e8:	00003497          	auipc	s1,0x3
    35ec:	56048493          	addi	s1,s1,1376 # 6b48 <malloc+0x1620>
    link("README", "");
    35f0:	00002b17          	auipc	s6,0x2
    35f4:	240b0b13          	addi	s6,s6,576 # 5830 <malloc+0x308>
    fd = open("", O_CREATE);
    35f8:	20000a13          	li	s4,512
    fd = open("xx", O_CREATE);
    35fc:	00004997          	auipc	s3,0x4
    3600:	93c98993          	addi	s3,s3,-1732 # 6f38 <malloc+0x1a10>
    3604:	a835                	j	3640 <iref+0x7c>
      printf("%s: mkdir irefd failed\n", s);
    3606:	85de                	mv	a1,s7
    3608:	00004517          	auipc	a0,0x4
    360c:	a4050513          	addi	a0,a0,-1472 # 7048 <malloc+0x1b20>
    3610:	661010ef          	jal	5470 <printf>
      exit(1);
    3614:	4505                	li	a0,1
    ...
    3620:	a4450513          	addi	a0,a0,-1468 # 7060 <malloc+0x1b38>
    3624:	64d010ef          	jal	5470 <printf>
      exit(1);
    3628:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3684:	1e098993          	addi	s3,s3,480 # 6860 <malloc+0x1338>
    unlink("irefd");
    3688:	00004917          	auipc	s2,0x4
    368c:	9b890913          	addi	s2,s2,-1608 # 7040 <malloc+0x1b18>
    chdir("..");
    3690:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    36a4:	16850513          	addi	a0,a0,360 # 6808 <malloc+0x12e0>
...
00000000000036c2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    36d2:	9aa50513          	addi	a0,a0,-1622 # 7078 <malloc+0x1b50>
  ...
  if(pid == 0){
    ...
    36ee:	98e50513          	addi	a0,a0,-1650 # 7078 <malloc+0x1b50>
    ...
    3700:	99c50513          	addi	a0,a0,-1636 # 7098 <malloc+0x1b70>
    3704:	56d010ef          	jal	5470 <printf>
      exit(1);
    3708:	4505                	li	a0,1
    ...
    3714:	97050513          	addi	a0,a0,-1680 # 7080 <malloc+0x1b58>
    3718:	559010ef          	jal	5470 <printf>
    exit(1);
    371c:	4505                	li	a0,1
    ...
    3728:	7c450513          	addi	a0,a0,1988 # 5ee8 <malloc+0x9c0>
    372c:	545010ef          	jal	5470 <printf>
    exit(1);
    3730:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3746:	93650513          	addi	a0,a0,-1738 # 7078 <malloc+0x1b50>
    374a:	0f1010ef          	jal	503a <unlink>
    374e:	c919                	beqz	a0,3764 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    3750:	85a6                	mv	a1,s1
    3752:	00003517          	auipc	a0,0x3
    3756:	98650513          	addi	a0,a0,-1658 # 60d8 <malloc+0xbb0>
    375a:	517010ef          	jal	5470 <printf>
    exit(1);
    375e:	4505                	li	a0,1
...
0000000000003774 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3784:	94050513          	addi	a0,a0,-1728 # 70c0 <malloc+0x1b98>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    37a4:	92050513          	addi	a0,a0,-1760 # 70c0 <malloc+0x1b98>
  ...
  pause(10); // one second
    ...
    37cc:	8e050513          	addi	a0,a0,-1824 # 60a8 <malloc+0xb80>
    37d0:	4a1010ef          	jal	5470 <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e0:	8e450513          	addi	a0,a0,-1820 # 70c0 <malloc+0x1b98>
    ...
    37fc:	8c850513          	addi	a0,a0,-1848 # 70c0 <malloc+0x1b98>
...
0000000000003810 <killstatus>:
{
  ...
  exit(0);
    ...
    386a:	68250513          	addi	a0,a0,1666 # 5ee8 <malloc+0x9c0>
    386e:	403010ef          	jal	5470 <printf>
      exit(1);
    3872:	4505                	li	a0,1
    ...
    3884:	85050513          	addi	a0,a0,-1968 # 70d0 <malloc+0x1ba8>
    3888:	3e9010ef          	jal	5470 <printf>
       exit(1);
    388c:	4505                	li	a0,1
...
0000000000003892 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    38b8:	7f450513          	addi	a0,a0,2036 # 60a8 <malloc+0xb80>
    38bc:	3b5010ef          	jal	5470 <printf>
    exit(1);
    38c0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    38da:	61250513          	addi	a0,a0,1554 # 5ee8 <malloc+0x9c0>
    38de:	393010ef          	jal	5470 <printf>
    exit(1);
    38e2:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    390a:	dc258593          	addi	a1,a1,-574 # 56c8 <malloc+0x1a0>
    ...
    392c:	5c050513          	addi	a0,a0,1472 # 5ee8 <malloc+0x9c0>
    3930:	341010ef          	jal	5470 <printf>
     exit(1);
    3934:	4505                	li	a0,1
    ...
    3940:	7b450513          	addi	a0,a0,1972 # 70f0 <malloc+0x1bc8>
    3944:	32d010ef          	jal	5470 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3970:	79c50513          	addi	a0,a0,1948 # 7108 <malloc+0x1be0>
    3974:	2fd010ef          	jal	5470 <printf>
}
  ...
  printf("kill... ");
    ...
    3994:	79050513          	addi	a0,a0,1936 # 7120 <malloc+0x1bf8>
    3998:	2d9010ef          	jal	5470 <printf>
  kill(pid1);
    399c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    39b2:	78250513          	addi	a0,a0,1922 # 7130 <malloc+0x1c08>
    39b6:	2bb010ef          	jal	5470 <printf>
  wait(0);
    39ba:	4501                	li	a0,0
...
00000000000039ce <reparent>:
{
  ...
  exit(0);
    ...
    3a12:	4da50513          	addi	a0,a0,1242 # 5ee8 <malloc+0x9c0>
    3a16:	25b010ef          	jal	5470 <printf>
      exit(1);
    3a1a:	4505                	li	a0,1
    ...
    3a26:	64e50513          	addi	a0,a0,1614 # 6070 <malloc+0xb48>
    3a2a:	247010ef          	jal	5470 <printf>
        exit(1);
    3a2e:	4505                	li	a0,1
...
0000000000003a4e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3a8e:	56650513          	addi	a0,a0,1382 # 5ff0 <malloc+0xac8>
    3a92:	1df010ef          	jal	5470 <printf>
    exit(1);
    3a96:	4505                	li	a0,1
    ...
    3ab8:	e0458593          	addi	a1,a1,-508 # 78b8 <malloc+0x2390>
    ...
    3ad6:	66e58593          	addi	a1,a1,1646 # 7140 <malloc+0x1c18>
  ...
  c = sbrk(PGSIZE);
    ...
    3b30:	61c50513          	addi	a0,a0,1564 # 7148 <malloc+0x1c20>
    3b34:	13d010ef          	jal	5470 <printf>
  ...
  if(pid == 0){
    ...
    3b7a:	62250513          	addi	a0,a0,1570 # 7198 <malloc+0x1c70>
    3b7e:	0f3010ef          	jal	5470 <printf>
    exit(1);
    3b82:	4505                	li	a0,1
    ...
    3b8e:	5ee50513          	addi	a0,a0,1518 # 7178 <malloc+0x1c50>
    3b92:	0df010ef          	jal	5470 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba2:	34a50513          	addi	a0,a0,842 # 5ee8 <malloc+0x9c0>
    3ba6:	0cb010ef          	jal	5470 <printf>
    exit(1);
    3baa:	4505                	li	a0,1
...
0000000000003be2 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3c26:	6084                	ld	s1,0(s1)
      free(m1);
    3c28:	07b010ef          	jal	54a2 <free>
    while(m1){
    3c2c:	fce5                	bnez	s1,3c24 <mem+0x42>
    m1 = malloc(1024*20);
    3c2e:	6515                	lui	a0,0x5
    3c30:	0f9010ef          	jal	5528 <malloc>
    if(m1 == 0){
    3c34:	c511                	beqz	a0,3c40 <mem+0x5e>
    free(m1);
    3c36:	06d010ef          	jal	54a2 <free>
    exit(0);
    3c3a:	4501                	li	a0,0
    ...
    3c46:	58650513          	addi	a0,a0,1414 # 71c8 <malloc+0x1ca0>
    3c4a:	027010ef          	jal	5470 <printf>
      exit(1);
    3c4e:	4505                	li	a0,1
...
0000000000003c5a <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3c6e:	57e50513          	addi	a0,a0,1406 # 71e8 <malloc+0x1cc0>
    3c72:	3c8010ef          	jal	503a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3c76:	20200593          	li	a1,514
    3c7a:	00003517          	auipc	a0,0x3
    3c7e:	56e50513          	addi	a0,a0,1390 # 71e8 <malloc+0x1cc0>
  ...
  if(pid == 0) {
    ...
    3ce6:	51650513          	addi	a0,a0,1302 # 71f8 <malloc+0x1cd0>
    3cea:	786010ef          	jal	5470 <printf>
    exit(1);
    3cee:	4505                	li	a0,1
    ...
    3cfc:	52850513          	addi	a0,a0,1320 # 7220 <malloc+0x1cf8>
    3d00:	770010ef          	jal	5470 <printf>
      exit(1);
    3d04:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3d30:	4bc50513          	addi	a0,a0,1212 # 71e8 <malloc+0x1cc0>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3d68:	4dc50513          	addi	a0,a0,1244 # 7240 <malloc+0x1d18>
    3d6c:	704010ef          	jal	5470 <printf>
    exit(1);
    3d70:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3d98:	45450513          	addi	a0,a0,1108 # 71e8 <malloc+0x1cc0>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3dba:	4b250513          	addi	a0,a0,1202 # 7268 <malloc+0x1d40>
    3dbe:	6b2010ef          	jal	5470 <printf>
    exit(1);
    3dc2:	4505                	li	a0,1
...
0000000000003dc8 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3dec:	49878793          	addi	a5,a5,1176 # 7280 <malloc+0x1d58>
    3df0:	f6f43823          	sd	a5,-144(s0)
    3df4:	00003797          	auipc	a5,0x3
    3df8:	49478793          	addi	a5,a5,1172 # 7288 <malloc+0x1d60>
    3dfc:	f6f43c23          	sd	a5,-136(s0)
    3e00:	00003797          	auipc	a5,0x3
    3e04:	49078793          	addi	a5,a5,1168 # 7290 <malloc+0x1d68>
    3e08:	f8f43023          	sd	a5,-128(s0)
    3e0c:	00003797          	auipc	a5,0x3
    3e10:	48c78793          	addi	a5,a5,1164 # 7298 <malloc+0x1d70>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e76:	07650513          	addi	a0,a0,118 # 5ee8 <malloc+0x9c0>
    3e7a:	5f6010ef          	jal	5470 <printf>
      exit(1);
    3e7e:	4505                	li	a0,1
    ...
    3ed6:	0ae50513          	addi	a0,a0,174 # 5f80 <malloc+0xa58>
    3eda:	596010ef          	jal	5470 <printf>
        exit(1);
    3ede:	4505                	li	a0,1
    3ee0:	10a010ef          	jal	4fea <exit>
          printf("write failed %d\n", n);
    3ee4:	00003517          	auipc	a0,0x3
    3ee8:	3bc50513          	addi	a0,a0,956 # 72a0 <malloc+0x1d78>
    3eec:	584010ef          	jal	5470 <printf>
          exit(1);
    3ef0:	4505                	li	a0,1
    ...
    3f02:	3ba50513          	addi	a0,a0,954 # 72b8 <malloc+0x1d90>
    3f06:	56a010ef          	jal	5470 <printf>
          exit(1);
    3f0a:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3f6c:	36050513          	addi	a0,a0,864 # 72c8 <malloc+0x1da0>
    3f70:	500010ef          	jal	5470 <printf>
      exit(1);
    3f74:	4505                	li	a0,1
...
0000000000003f98 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3fda:	30ac8c93          	addi	s9,s9,778 # 72e0 <malloc+0x1db8>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    402e:	2be50513          	addi	a0,a0,702 # 72e8 <malloc+0x1dc0>
    4032:	43e010ef          	jal	5470 <printf>
        exit(1);
    4036:	4505                	li	a0,1
    ...
    4044:	2a050513          	addi	a0,a0,672 # 72e0 <malloc+0x1db8>
  ...
  fd = open(".", 0);
    ...
    406c:	cd850513          	addi	a0,a0,-808 # 5d40 <malloc+0x818>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    40da:	23250513          	addi	a0,a0,562 # 7308 <malloc+0x1de0>
    40de:	392010ef          	jal	5470 <printf>
        exit(1);
    40e2:	4505                	li	a0,1
    ...
    40f2:	23a50513          	addi	a0,a0,570 # 7328 <malloc+0x1e00>
    40f6:	37a010ef          	jal	5470 <printf>
        exit(1);
    40fa:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4124:	23050513          	addi	a0,a0,560 # 7350 <malloc+0x1e28>
    4128:	348010ef          	jal	5470 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    4138:	db450513          	addi	a0,a0,-588 # 5ee8 <malloc+0x9c0>
    413c:	334010ef          	jal	5470 <printf>
      exit(1);
    4140:	4505                	li	a0,1
...
0000000000004278 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4292:	0fa50513          	addi	a0,a0,250 # 7388 <malloc+0x1e60>
    4296:	5a5000ef          	jal	503a <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    429a:	20200593          	li	a1,514
    429e:	00003517          	auipc	a0,0x3
    42a2:	0ea50513          	addi	a0,a0,234 # 7388 <malloc+0x1e60>
  ...
  fd = open("bigfile.dat", 0);
    ...
    42ea:	0a250513          	addi	a0,a0,162 # 7388 <malloc+0x1e60>
  ...
  for(i = 0; ; i++){
    ...
    4344:	05850513          	addi	a0,a0,88 # 7398 <malloc+0x1e70>
    4348:	128010ef          	jal	5470 <printf>
    exit(1);
    434c:	4505                	li	a0,1
    ...
    4358:	06450513          	addi	a0,a0,100 # 73b8 <malloc+0x1e90>
    435c:	114010ef          	jal	5470 <printf>
      exit(1);
    4360:	4505                	li	a0,1
    ...
    436c:	07050513          	addi	a0,a0,112 # 73d8 <malloc+0x1eb0>
    4370:	100010ef          	jal	5470 <printf>
    exit(1);
    4374:	4505                	li	a0,1
    ...
    4380:	07c50513          	addi	a0,a0,124 # 73f8 <malloc+0x1ed0>
    4384:	0ec010ef          	jal	5470 <printf>
      exit(1);
    4388:	4505                	li	a0,1
    ...
    4394:	08850513          	addi	a0,a0,136 # 7418 <malloc+0x1ef0>
    4398:	0d8010ef          	jal	5470 <printf>
      exit(1);
    439c:	4505                	li	a0,1
    ...
    43a8:	08c50513          	addi	a0,a0,140 # 7430 <malloc+0x1f08>
    43ac:	0c4010ef          	jal	5470 <printf>
      exit(1);
    43b0:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    43ca:	fc250513          	addi	a0,a0,-62 # 7388 <malloc+0x1e60>
    ...
    43ec:	06850513          	addi	a0,a0,104 # 7450 <malloc+0x1f28>
    43f0:	080010ef          	jal	5470 <printf>
    exit(1);
    43f4:	4505                	li	a0,1
...
00000000000043fa <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    440a:	06a50513          	addi	a0,a0,106 # 7470 <malloc+0x1f48>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4430:	04450513          	addi	a0,a0,68 # 7470 <malloc+0x1f48>
  ...
  close(fd);
    ...
    448e:	1ce50513          	addi	a0,a0,462 # 5658 <malloc+0x130>
    4492:	391000ef          	jal	5022 <exec>
    fd = open("bigarg-ok", O_CREATE);
    4496:	20000593          	li	a1,512
    449a:	00003517          	auipc	a0,0x3
    449e:	fd650513          	addi	a0,a0,-42 # 7470 <malloc+0x1f48>
    ...
    44b6:	fce50513          	addi	a0,a0,-50 # 7480 <malloc+0x1f58>
    44ba:	7b7000ef          	jal	5470 <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	fd650513          	addi	a0,a0,-42 # 74a0 <malloc+0x1f78>
    44d2:	79f000ef          	jal	5470 <printf>
    exit(1);
    44d6:	4505                	li	a0,1
...
00000000000044dc <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4526:	f9e50513          	addi	a0,a0,-98 # 74c0 <malloc+0x1f98>
    452a:	747000ef          	jal	5470 <printf>
    exit(1);
    452e:	4505                	li	a0,1
    4530:	2bb000ef          	jal	4fea <exit>
      printf("failed to read value from memory\n");
    4534:	00003517          	auipc	a0,0x3
    4538:	fa450513          	addi	a0,a0,-92 # 74d8 <malloc+0x1fb0>
    453c:	735000ef          	jal	5470 <printf>
      exit(1);
    4540:	4505                	li	a0,1
...
0000000000004546 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    45b4:	f1050513          	addi	a0,a0,-240 # 74c0 <malloc+0x1f98>
    45b8:	6b9000ef          	jal	5470 <printf>
    exit(1);
    45bc:	4505                	li	a0,1
    45be:	22d000ef          	jal	4fea <exit>
      printf("error forking\n");
    45c2:	00003517          	auipc	a0,0x3
    45c6:	f3e50513          	addi	a0,a0,-194 # 7500 <malloc+0x1fd8>
    45ca:	6a7000ef          	jal	5470 <printf>
      exit(1);
    45ce:	4505                	li	a0,1
    ...
    45ea:	f2a50513          	addi	a0,a0,-214 # 7510 <malloc+0x1fe8>
    45ee:	683000ef          	jal	5470 <printf>
        exit(1);
    45f2:	4505                	li	a0,1
...
00000000000045f8 <lazy_copy>:
{
    ...
    4642:	eea50513          	addi	a0,a0,-278 # 7528 <malloc+0x2000>
    4646:	62b000ef          	jal	5470 <printf>
      exit(1);
    464a:	4505                	li	a0,1
    464c:	19f000ef          	jal	4fea <exit>
  unsigned long bad[] = {
    4650:	00003797          	auipc	a5,0x3
    4654:	55078793          	addi	a5,a5,1360 # 7ba0 <malloc+0x2678>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    4684:	1b0a8a93          	addi	s5,s5,432 # 5830 <malloc+0x308>
    ...
    4694:	0b0b0b13          	addi	s6,s6,176 # 5740 <malloc+0x218>
    int fd = open("README", 0);
    4698:	4581                	li	a1,0
    469a:	8556                	mv	a0,s5
  ...
  exit(0);
    ...
    46f0:	e6c50513          	addi	a0,a0,-404 # 7558 <malloc+0x2030>
    46f4:	57d000ef          	jal	5470 <printf>
    46f8:	4505                	li	a0,1
    46fa:	0f1000ef          	jal	4fea <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    46fe:	00003517          	auipc	a0,0x3
    4702:	e7250513          	addi	a0,a0,-398 # 7570 <malloc+0x2048>
    4706:	56b000ef          	jal	5470 <printf>
    470a:	4505                	li	a0,1
    470c:	0df000ef          	jal	4fea <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4710:	00003517          	auipc	a0,0x3
    4714:	e7050513          	addi	a0,a0,-400 # 7580 <malloc+0x2058>
    4718:	559000ef          	jal	5470 <printf>
    471c:	4505                	li	a0,1
    471e:	0cd000ef          	jal	4fea <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4722:	00003517          	auipc	a0,0x3
    4726:	e7650513          	addi	a0,a0,-394 # 7598 <malloc+0x2070>
    472a:	547000ef          	jal	5470 <printf>
    472e:	4505                	li	a0,1
...
0000000000004734 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    4786:	e2e50513          	addi	a0,a0,-466 # 75b0 <malloc+0x2088>
    478a:	4e7000ef          	jal	5470 <printf>
    exit(1);
    478e:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    47ae:	e3650513          	addi	a0,a0,-458 # 75e0 <malloc+0x20b8>
    47b2:	4bf000ef          	jal	5470 <printf>
    exit(1);
    47b6:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    47d4:	e4850513          	addi	a0,a0,-440 # 7618 <malloc+0x20f0>
    47d8:	499000ef          	jal	5470 <printf>
    exit(1);
    47dc:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    47f4:	e5050513          	addi	a0,a0,-432 # 7640 <malloc+0x2118>
    47f8:	479000ef          	jal	5470 <printf>
    exit(1);
    47fc:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4814:	e5850513          	addi	a0,a0,-424 # 7668 <malloc+0x2140>
    4818:	459000ef          	jal	5470 <printf>
    exit(1);
    481c:	4505                	li	a0,1
...
0000000000004828 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    484a:	e5250513          	addi	a0,a0,-430 # 7698 <malloc+0x2170>
    484e:	423000ef          	jal	5470 <printf>
  for(nfiles = 0; ; nfiles++){
    4852:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4900:	dac50513          	addi	a0,a0,-596 # 76a8 <malloc+0x2180>
    4904:	36d000ef          	jal	5470 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4920:	d9c50513          	addi	a0,a0,-612 # 76b8 <malloc+0x2190>
    4924:	34d000ef          	jal	5470 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    49e4:	cf850513          	addi	a0,a0,-776 # 76d8 <malloc+0x21b0>
    49e8:	289000ef          	jal	5470 <printf>
}
    ...
    4a36:	c9650513          	addi	a0,a0,-874 # 76c8 <malloc+0x21a0>
    4a3a:	237000ef          	jal	5470 <printf>
    close(fd);
    4a3e:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4a60:	c9450513          	addi	a0,a0,-876 # 76f0 <malloc+0x21c8>
    4a64:	20d000ef          	jal	5470 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4a84:	c9850513          	addi	a0,a0,-872 # 7718 <malloc+0x21f0>
    4a88:	1e9000ef          	jal	5470 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4aa4:	c6050513          	addi	a0,a0,-928 # 7700 <malloc+0x21d8>
    4aa8:	1c9000ef          	jal	5470 <printf>
    exit(1);
    4aac:	4505                	li	a0,1
    ...
    4ac0:	c6450513          	addi	a0,a0,-924 # 7720 <malloc+0x21f8>
    4ac4:	1ad000ef          	jal	5470 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    4b12:	c1a50513          	addi	a0,a0,-998 # 7728 <malloc+0x2200>
    4b16:	15b000ef          	jal	5470 <printf>
          return -1;
    4b1a:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
    ...
    4bb0:	b94c0c13          	addi	s8,s8,-1132 # 7740 <malloc+0x2218>
    ...
    4bca:	bb2d8d93          	addi	s11,s11,-1102 # 7778 <malloc+0x2250>
    ...
    4bdc:	b8050513          	addi	a0,a0,-1152 # 7758 <malloc+0x2230>
    4be0:	091000ef          	jal	5470 <printf>
    ...
    4c4e:	b5e50513          	addi	a0,a0,-1186 # 77a8 <malloc+0x2280>
    4c52:	01f000ef          	jal	5470 <printf>
      return 1;
    4c56:	4505                	li	a0,1
  return 0;
}
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4cb4:	b1058593          	addi	a1,a1,-1264 # 77c0 <malloc+0x2298>
  ...
  int continuous = 0;
    ...
    4d08:	acc50513          	addi	a0,a0,-1332 # 77d0 <malloc+0x22a8>
    4d0c:	764000ef          	jal	5470 <printf>
    exit(1);
    4d10:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4d26:	ade50513          	addi	a0,a0,-1314 # 7800 <malloc+0x22d8>
    4d2a:	746000ef          	jal	5470 <printf>
  exit(0);
    4d2e:	4501                	li	a0,0
...
putc(int fd, char c)
{
    50ca:	1101                	addi	sp,sp,-32
    50cc:	ec06                	sd	ra,24(sp)
    50ce:	e822                	sd	s0,16(sp)
    50d0:	1000                	addi	s0,sp,32
    50d2:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    50d6:	4605                	li	a2,1
    50d8:	fef40593          	addi	a1,s0,-17
    50dc:	f2fff0ef          	jal	500a <write>
}
    50e0:	60e2                	ld	ra,24(sp)
    50e2:	6442                	ld	s0,16(sp)
    50e4:	6105                	addi	sp,sp,32
    50e6:	8082                	ret

00000000000050e8 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    50e8:	715d                	addi	sp,sp,-80
    50ea:	e486                	sd	ra,72(sp)
    50ec:	e0a2                	sd	s0,64(sp)
    50ee:	f84a                	sd	s2,48(sp)
    50f0:	f44e                	sd	s3,40(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    50f6:	c6d1                	beqz	a3,5182 <printint+0x9a>
    50f8:	0805d563          	bgez	a1,5182 <printint+0x9a>
    neg = 1;
    x = -xx;
    50fc:	40b005b3          	neg	a1,a1
    neg = 1;
    5100:	4305                	li	t1,1
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    510a:	00003817          	auipc	a6,0x3
    510e:	b3e80813          	addi	a6,a6,-1218 # 7c48 <digits>
    5112:	88ba                	mv	a7,a4
    5114:	0017051b          	addiw	a0,a4,1
    5118:	872a                	mv	a4,a0
    511a:	02c5f7b3          	remu	a5,a1,a2
    511e:	97c2                	add	a5,a5,a6
    5120:	0007c783          	lbu	a5,0(a5)
    5124:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5128:	87ae                	mv	a5,a1
    512a:	02c5d5b3          	divu	a1,a1,a2
    512e:	0685                	addi	a3,a3,1
    5130:	fec7f1e3          	bgeu	a5,a2,5112 <printint+0x2a>
  if(neg)
    5134:	00030c63          	beqz	t1,514c <printint+0x64>
    buf[i++] = '-';
    5138:	fd050793          	addi	a5,a0,-48
    513c:	00878533          	add	a0,a5,s0
    5140:	02d00793          	li	a5,45
    5144:	fef50423          	sb	a5,-24(a0)
    5148:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
    514c:	02e05563          	blez	a4,5176 <printint+0x8e>
    5150:	fc26                	sd	s1,56(sp)
    5152:	377d                	addiw	a4,a4,-1
    5154:	00e984b3          	add	s1,s3,a4
    5158:	19fd                	addi	s3,s3,-1 # fff <bigdir+0x10b>
    515a:	99ba                	add	s3,s3,a4
    515c:	1702                	slli	a4,a4,0x20
    515e:	9301                	srli	a4,a4,0x20
    5160:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5164:	0004c583          	lbu	a1,0(s1)
    5168:	854a                	mv	a0,s2
    516a:	f61ff0ef          	jal	50ca <putc>
  while(--i >= 0)
    516e:	14fd                	addi	s1,s1,-1
    5170:	ff349ae3          	bne	s1,s3,5164 <printint+0x7c>
    5174:	74e2                	ld	s1,56(sp)
}
    5176:	60a6                	ld	ra,72(sp)
    5178:	6406                	ld	s0,64(sp)
    517a:	7942                	ld	s2,48(sp)
    517c:	79a2                	ld	s3,40(sp)
    517e:	6161                	addi	sp,sp,80
    5180:	8082                	ret
  neg = 0;
    5182:	4301                	li	t1,0
    5184:	bfbd                	j	5102 <printint+0x1a>

0000000000005186 <vprintf>:
}
...
{
    5186:	711d                	addi	sp,sp,-96
    5188:	ec86                	sd	ra,88(sp)
    518a:	e8a2                	sd	s0,80(sp)
    518c:	e4a6                	sd	s1,72(sp)
    518e:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5190:	0005c483          	lbu	s1,0(a1)
    5194:	22048363          	beqz	s1,53ba <vprintf+0x234>
    5198:	e0ca                	sd	s2,64(sp)
    519a:	fc4e                	sd	s3,56(sp)
    519c:	f852                	sd	s4,48(sp)
    519e:	f456                	sd	s5,40(sp)
    51a0:	f05a                	sd	s6,32(sp)
    51a2:	ec5e                	sd	s7,24(sp)
    51a4:	e862                	sd	s8,16(sp)
    51a6:	8b2a                	mv	s6,a0
    51a8:	8a2e                	mv	s4,a1
    51aa:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    51b2:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    51b6:	06400c13          	li	s8,100
    51ba:	a00d                	j	51dc <vprintf+0x56>
        putc(fd, c0);
    51bc:	85a6                	mv	a1,s1
    51be:	855a                	mv	a0,s6
    51c0:	f0bff0ef          	jal	50ca <putc>
    51c4:	a019                	j	51ca <vprintf+0x44>
    } else if(state == '%'){
    51c6:	03598363          	beq	s3,s5,51ec <vprintf+0x66>
  for(i = 0; fmt[i]; i++){
    51ca:	0019079b          	addiw	a5,s2,1
    51ce:	893e                	mv	s2,a5
    51d0:	873e                	mv	a4,a5
    51d2:	97d2                	add	a5,a5,s4
    51d4:	0007c483          	lbu	s1,0(a5)
    51d8:	1c048a63          	beqz	s1,53ac <vprintf+0x226>
    c0 = fmt[i] & 0xff;
    51dc:	0004879b          	sext.w	a5,s1
    if(state == 0){
    51e0:	fe0993e3          	bnez	s3,51c6 <vprintf+0x40>
      if(c0 == '%'){
    51e4:	fd579ce3          	bne	a5,s5,51bc <vprintf+0x36>
        state = '%';
    51e8:	89be                	mv	s3,a5
    51ea:	b7c5                	j	51ca <vprintf+0x44>
      if(c0) c1 = fmt[i+1] & 0xff;
    51ec:	00ea06b3          	add	a3,s4,a4
    51f0:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
    51f4:	1c060863          	beqz	a2,53c4 <vprintf+0x23e>
      if(c0 == 'd'){
    51f8:	03878763          	beq	a5,s8,5226 <vprintf+0xa0>
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    51fc:	f9478693          	addi	a3,a5,-108
    5200:	0016b693          	seqz	a3,a3
    5204:	f9c60593          	addi	a1,a2,-100
    5208:	e99d                	bnez	a1,523e <vprintf+0xb8>
    520a:	ca95                	beqz	a3,523e <vprintf+0xb8>
        printint(fd, va_arg(ap, uint64), 10, 1);
    520c:	008b8493          	addi	s1,s7,8
    5210:	4685                	li	a3,1
    5212:	4629                	li	a2,10
    5214:	000bb583          	ld	a1,0(s7)
    5218:	855a                	mv	a0,s6
    521a:	ecfff0ef          	jal	50e8 <printint>
        i += 1;
    521e:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    5220:	8ba6                	mv	s7,s1
      ...
      state = 0;
    5222:	4981                	li	s3,0
    5224:	b75d                	j	51ca <vprintf+0x44>
        printint(fd, va_arg(ap, int), 10, 1);
    5226:	008b8493          	addi	s1,s7,8
    522a:	4685                	li	a3,1
    522c:	4629                	li	a2,10
    522e:	000ba583          	lw	a1,0(s7)
    5232:	855a                	mv	a0,s6
    5234:	eb5ff0ef          	jal	50e8 <printint>
    5238:	8ba6                	mv	s7,s1
      state = 0;
    523a:	4981                	li	s3,0
    523c:	b779                	j	51ca <vprintf+0x44>
      if(c1) c2 = fmt[i+2] & 0xff;
    523e:	9752                	add	a4,a4,s4
    5240:	00274583          	lbu	a1,2(a4)
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    5244:	f9460713          	addi	a4,a2,-108
    5248:	00173713          	seqz	a4,a4
    524c:	8f75                	and	a4,a4,a3
    524e:	f9c58513          	addi	a0,a1,-100
    5252:	18051363          	bnez	a0,53d8 <vprintf+0x252>
    5256:	18070163          	beqz	a4,53d8 <vprintf+0x252>
        printint(fd, va_arg(ap, uint64), 10, 1);
    525a:	008b8493          	addi	s1,s7,8
    525e:	4685                	li	a3,1
    5260:	4629                	li	a2,10
    5262:	000bb583          	ld	a1,0(s7)
    5266:	855a                	mv	a0,s6
    5268:	e81ff0ef          	jal	50e8 <printint>
        i += 2;
    526c:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    526e:	8ba6                	mv	s7,s1
      state = 0;
    5270:	4981                	li	s3,0
        i += 2;
    5272:	bfa1                	j	51ca <vprintf+0x44>
        printint(fd, va_arg(ap, uint32), 10, 0);
    5274:	008b8493          	addi	s1,s7,8
    5278:	4681                	li	a3,0
    527a:	4629                	li	a2,10
    527c:	000be583          	lwu	a1,0(s7)
    5280:	855a                	mv	a0,s6
    5282:	e67ff0ef          	jal	50e8 <printint>
    5286:	8ba6                	mv	s7,s1
      state = 0;
    5288:	4981                	li	s3,0
    528a:	b781                	j	51ca <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    528c:	008b8493          	addi	s1,s7,8
    5290:	4681                	li	a3,0
    5292:	4629                	li	a2,10
    5294:	000bb583          	ld	a1,0(s7)
    5298:	855a                	mv	a0,s6
    529a:	e4fff0ef          	jal	50e8 <printint>
        i += 1;
    529e:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    52a0:	8ba6                	mv	s7,s1
      state = 0;
    52a2:	4981                	li	s3,0
    52a4:	b71d                	j	51ca <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    52a6:	008b8493          	addi	s1,s7,8
    52aa:	4681                	li	a3,0
    52ac:	4629                	li	a2,10
    52ae:	000bb583          	ld	a1,0(s7)
    52b2:	855a                	mv	a0,s6
    52b4:	e35ff0ef          	jal	50e8 <printint>
        i += 2;
    52b8:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    52ba:	8ba6                	mv	s7,s1
      state = 0;
    52bc:	4981                	li	s3,0
        i += 2;
    52be:	b731                	j	51ca <vprintf+0x44>
        printint(fd, va_arg(ap, uint32), 16, 0);
    52c0:	008b8493          	addi	s1,s7,8
    52c4:	4681                	li	a3,0
    52c6:	4641                	li	a2,16
    52c8:	000be583          	lwu	a1,0(s7)
    52cc:	855a                	mv	a0,s6
    52ce:	e1bff0ef          	jal	50e8 <printint>
    52d2:	8ba6                	mv	s7,s1
      state = 0;
    52d4:	4981                	li	s3,0
    52d6:	bdd5                	j	51ca <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 16, 0);
    52d8:	008b8493          	addi	s1,s7,8
    52dc:	4681                	li	a3,0
    52de:	4641                	li	a2,16
    52e0:	000bb583          	ld	a1,0(s7)
    52e4:	855a                	mv	a0,s6
    52e6:	e03ff0ef          	jal	50e8 <printint>
        i += 1;
    52ea:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    52ec:	8ba6                	mv	s7,s1
      state = 0;
    52ee:	4981                	li	s3,0
    52f0:	bde9                	j	51ca <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 16, 0);
    52f2:	008b8493          	addi	s1,s7,8
    52f6:	4681                	li	a3,0
    52f8:	4641                	li	a2,16
    52fa:	000bb583          	ld	a1,0(s7)
    52fe:	855a                	mv	a0,s6
    5300:	de9ff0ef          	jal	50e8 <printint>
        i += 2;
    5304:	2909                	addiw	s2,s2,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    5306:	8ba6                	mv	s7,s1
      state = 0;
    5308:	4981                	li	s3,0
        i += 2;
    530a:	b5c1                	j	51ca <vprintf+0x44>
    530c:	e466                	sd	s9,8(sp)
        printptr(fd, va_arg(ap, uint64));
    530e:	008b8793          	addi	a5,s7,8
    5312:	8cbe                	mv	s9,a5
    5314:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5318:	03000593          	li	a1,48
    531c:	855a                	mv	a0,s6
    531e:	dadff0ef          	jal	50ca <putc>
  putc(fd, 'x');
    5322:	07800593          	li	a1,120
    5326:	855a                	mv	a0,s6
    5328:	da3ff0ef          	jal	50ca <putc>
    532c:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    532e:	00003b97          	auipc	s7,0x3
    5332:	91ab8b93          	addi	s7,s7,-1766 # 7c48 <digits>
    5336:	03c9d793          	srli	a5,s3,0x3c
    533a:	97de                	add	a5,a5,s7
    533c:	0007c583          	lbu	a1,0(a5)
    5340:	855a                	mv	a0,s6
    5342:	d89ff0ef          	jal	50ca <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5346:	0992                	slli	s3,s3,0x4
    5348:	34fd                	addiw	s1,s1,-1
    534a:	f4f5                	bnez	s1,5336 <vprintf+0x1b0>
        printptr(fd, va_arg(ap, uint64));
    534c:	8be6                	mv	s7,s9
      state = 0;
    534e:	4981                	li	s3,0
    5350:	6ca2                	ld	s9,8(sp)
    5352:	bda5                	j	51ca <vprintf+0x44>
        putc(fd, va_arg(ap, uint32));
    5354:	008b8493          	addi	s1,s7,8
    5358:	000bc583          	lbu	a1,0(s7)
    535c:	855a                	mv	a0,s6
    535e:	d6dff0ef          	jal	50ca <putc>
    5362:	8ba6                	mv	s7,s1
      state = 0;
    5364:	4981                	li	s3,0
    5366:	b595                	j	51ca <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    5368:	008b8993          	addi	s3,s7,8
    536c:	000bb483          	ld	s1,0(s7)
    5370:	cc91                	beqz	s1,538c <vprintf+0x206>
        for(; *s; s++)
    5372:	0004c583          	lbu	a1,0(s1)
    5376:	c985                	beqz	a1,53a6 <vprintf+0x220>
          putc(fd, *s);
    5378:	855a                	mv	a0,s6
    537a:	d51ff0ef          	jal	50ca <putc>
        for(; *s; s++)
    537e:	0485                	addi	s1,s1,1
    5380:	0004c583          	lbu	a1,0(s1)
    5384:	f9f5                	bnez	a1,5378 <vprintf+0x1f2>
        if((s = va_arg(ap, char*)) == 0)
    5386:	8bce                	mv	s7,s3
      state = 0;
    5388:	4981                	li	s3,0
    538a:	b581                	j	51ca <vprintf+0x44>
          s = "(null)";
    538c:	00003497          	auipc	s1,0x3
    5390:	80c48493          	addi	s1,s1,-2036 # 7b98 <malloc+0x2670>
        for(; *s; s++)
    5394:	02800593          	li	a1,40
    5398:	b7c5                	j	5378 <vprintf+0x1f2>
        putc(fd, '%');
    539a:	85be                	mv	a1,a5
    539c:	855a                	mv	a0,s6
    539e:	d2dff0ef          	jal	50ca <putc>
      state = 0;
    53a2:	4981                	li	s3,0
    53a4:	b51d                	j	51ca <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    53a6:	8bce                	mv	s7,s3
      state = 0;
    53a8:	4981                	li	s3,0
    53aa:	b505                	j	51ca <vprintf+0x44>
    53ac:	6906                	ld	s2,64(sp)
    53ae:	79e2                	ld	s3,56(sp)
    53b0:	7a42                	ld	s4,48(sp)
    53b2:	7aa2                	ld	s5,40(sp)
    53b4:	7b02                	ld	s6,32(sp)
    53b6:	6be2                	ld	s7,24(sp)
    53b8:	6c42                	ld	s8,16(sp)
    }
  }
}
    53ba:	60e6                	ld	ra,88(sp)
    53bc:	6446                	ld	s0,80(sp)
    53be:	64a6                	ld	s1,72(sp)
    53c0:	6125                	addi	sp,sp,96
    53c2:	8082                	ret
      if(c0 == 'd'){
    53c4:	06400713          	li	a4,100
    53c8:	e4e78fe3          	beq	a5,a4,5226 <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
    53cc:	f9478693          	addi	a3,a5,-108
    53d0:	0016b693          	seqz	a3,a3
      c1 = c2 = 0;
    53d4:	85b2                	mv	a1,a2
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    53d6:	4701                	li	a4,0
      } else if(c0 == 'u'){
    53d8:	07500513          	li	a0,117
    53dc:	e8a78ce3          	beq	a5,a0,5274 <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
    53e0:	f8b60513          	addi	a0,a2,-117
    53e4:	e119                	bnez	a0,53ea <vprintf+0x264>
    53e6:	ea0693e3          	bnez	a3,528c <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    53ea:	f8b58513          	addi	a0,a1,-117
    53ee:	e119                	bnez	a0,53f4 <vprintf+0x26e>
    53f0:	ea071be3          	bnez	a4,52a6 <vprintf+0x120>
      } else if(c0 == 'x'){
    53f4:	07800513          	li	a0,120
    53f8:	eca784e3          	beq	a5,a0,52c0 <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
    53fc:	f8860613          	addi	a2,a2,-120
    5400:	e219                	bnez	a2,5406 <vprintf+0x280>
    5402:	ec069be3          	bnez	a3,52d8 <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    5406:	f8858593          	addi	a1,a1,-120
    540a:	e199                	bnez	a1,5410 <vprintf+0x28a>
    540c:	ee0713e3          	bnez	a4,52f2 <vprintf+0x16c>
      } else if(c0 == 'p'){
    5410:	07000713          	li	a4,112
    5414:	eee78ce3          	beq	a5,a4,530c <vprintf+0x186>
      } else if(c0 == 'c'){
    5418:	06300713          	li	a4,99
    541c:	f2e78ce3          	beq	a5,a4,5354 <vprintf+0x1ce>
      } else if(c0 == 's'){
    5420:	07300713          	li	a4,115
    5424:	f4e782e3          	beq	a5,a4,5368 <vprintf+0x1e2>
      } else if(c0 == '%'){
    5428:	02500713          	li	a4,37
    542c:	f6e787e3          	beq	a5,a4,539a <vprintf+0x214>
        putc(fd, '%');
    5430:	02500593          	li	a1,37
    5434:	855a                	mv	a0,s6
    5436:	c95ff0ef          	jal	50ca <putc>
        putc(fd, c0);
    543a:	85a6                	mv	a1,s1
    543c:	855a                	mv	a0,s6
    543e:	c8dff0ef          	jal	50ca <putc>
      state = 0;
    5442:	4981                	li	s3,0
    5444:	b359                	j	51ca <vprintf+0x44>

0000000000005446 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5446:	715d                	addi	sp,sp,-80
    5448:	ec06                	sd	ra,24(sp)
    544a:	e822                	sd	s0,16(sp)
    544c:	1000                	addi	s0,sp,32
    544e:	e010                	sd	a2,0(s0)
    5450:	e414                	sd	a3,8(s0)
    5452:	e818                	sd	a4,16(s0)
    5454:	ec1c                	sd	a5,24(s0)
    5456:	03043023          	sd	a6,32(s0)
    545a:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    545e:	8622                	mv	a2,s0
    5460:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5464:	d23ff0ef          	jal	5186 <vprintf>
}
    5468:	60e2                	ld	ra,24(sp)
    546a:	6442                	ld	s0,16(sp)
    546c:	6161                	addi	sp,sp,80
    546e:	8082                	ret

0000000000005470 <printf>:

void
printf(const char *fmt, ...)
{
    5470:	711d                	addi	sp,sp,-96
    5472:	ec06                	sd	ra,24(sp)
    5474:	e822                	sd	s0,16(sp)
    5476:	1000                	addi	s0,sp,32
    5478:	e40c                	sd	a1,8(s0)
    547a:	e810                	sd	a2,16(s0)
    547c:	ec14                	sd	a3,24(s0)
    547e:	f018                	sd	a4,32(s0)
    5480:	f41c                	sd	a5,40(s0)
    5482:	03043823          	sd	a6,48(s0)
    5486:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    548a:	00840613          	addi	a2,s0,8
    548e:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5492:	85aa                	mv	a1,a0
    5494:	4505                	li	a0,1
    5496:	cf1ff0ef          	jal	5186 <vprintf>
}
    549a:	60e2                	ld	ra,24(sp)
    549c:	6442                	ld	s0,16(sp)
    549e:	6125                	addi	sp,sp,96
    54a0:	8082                	ret

00000000000054a2 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    54a4:	e406                	sd	ra,8(sp)
    54a6:	e022                	sd	s0,0(sp)
    54a8:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    54aa:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    54ae:	00003797          	auipc	a5,0x3
    54b2:	fe27b783          	ld	a5,-30(a5) # 8490 <freep>
    54b6:	a039                	j	54c4 <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    54b8:	6398                	ld	a4,0(a5)
    54ba:	00e7e463          	bltu	a5,a4,54c2 <free+0x20>
    54be:	00e6ea63          	bltu	a3,a4,54d2 <free+0x30>
{
    54c2:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    54c4:	fed7fae3          	bgeu	a5,a3,54b8 <free+0x16>
    54c8:	6398                	ld	a4,0(a5)
    54ca:	00e6e463          	bltu	a3,a4,54d2 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    54ce:	fee7eae3          	bltu	a5,a4,54c2 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    54d2:	ff852583          	lw	a1,-8(a0)
    54d6:	6390                	ld	a2,0(a5)
    54d8:	02059813          	slli	a6,a1,0x20
    54dc:	01c85713          	srli	a4,a6,0x1c
    54e0:	9736                	add	a4,a4,a3
    54e2:	02e60563          	beq	a2,a4,550c <free+0x6a>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    54e6:	fec53823          	sd	a2,-16(a0)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    54ea:	4790                	lw	a2,8(a5)
    54ec:	02061593          	slli	a1,a2,0x20
    54f0:	01c5d713          	srli	a4,a1,0x1c
    54f4:	973e                	add	a4,a4,a5
    54f6:	02e68263          	beq	a3,a4,551a <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    54fa:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    54fc:	00003717          	auipc	a4,0x3
    5500:	f8f73a23          	sd	a5,-108(a4) # 8490 <freep>
}
    5504:	60a2                	ld	ra,8(sp)
    5506:	6402                	ld	s0,0(sp)
    5508:	0141                	addi	sp,sp,16
    550a:	8082                	ret
    bp->s.size += p->s.ptr->s.size;
    550c:	4618                	lw	a4,8(a2)
    550e:	9f2d                	addw	a4,a4,a1
    5510:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5514:	6398                	ld	a4,0(a5)
    5516:	6310                	ld	a2,0(a4)
    5518:	b7f9                	j	54e6 <free+0x44>
    p->s.size += bp->s.size;
    551a:	ff852703          	lw	a4,-8(a0)
    551e:	9f31                	addw	a4,a4,a2
    5520:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5522:	ff053683          	ld	a3,-16(a0)
    5526:	bfd1                	j	54fa <free+0x58>

0000000000005528 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5528:	7139                	addi	sp,sp,-64
    552a:	fc06                	sd	ra,56(sp)
    552c:	f822                	sd	s0,48(sp)
    552e:	f04a                	sd	s2,32(sp)
    5530:	ec4e                	sd	s3,24(sp)
    5532:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5534:	02051993          	slli	s3,a0,0x20
    5538:	0209d993          	srli	s3,s3,0x20
    553c:	09bd                	addi	s3,s3,15
    553e:	0049d993          	srli	s3,s3,0x4
    5542:	2985                	addiw	s3,s3,1
    5544:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    5546:	00003517          	auipc	a0,0x3
    554a:	f4a53503          	ld	a0,-182(a0) # 8490 <freep>
    554e:	c905                	beqz	a0,557e <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5550:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5552:	4798                	lw	a4,8(a5)
    5554:	09377663          	bgeu	a4,s3,55e0 <malloc+0xb8>
    5558:	f426                	sd	s1,40(sp)
    555a:	e852                	sd	s4,16(sp)
    555c:	e456                	sd	s5,8(sp)
    555e:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    5560:	8a4e                	mv	s4,s3
    5562:	6705                	lui	a4,0x1
    5564:	00e9f363          	bgeu	s3,a4,556a <malloc+0x42>
    5568:	6a05                	lui	s4,0x1
    556a:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    556e:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5572:	00003497          	auipc	s1,0x3
    5576:	f1e48493          	addi	s1,s1,-226 # 8490 <freep>
  if(p == SBRK_ERROR)
    557a:	5afd                	li	s5,-1
    557c:	a83d                	j	55ba <malloc+0x92>
    557e:	f426                	sd	s1,40(sp)
    5580:	e852                	sd	s4,16(sp)
    5582:	e456                	sd	s5,8(sp)
    5584:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    5586:	00009797          	auipc	a5,0x9
    558a:	73278793          	addi	a5,a5,1842 # ecb8 <base>
    558e:	00003717          	auipc	a4,0x3
    5592:	f0f73123          	sd	a5,-254(a4) # 8490 <freep>
    5596:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5598:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    559c:	b7d1                	j	5560 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    559e:	6398                	ld	a4,0(a5)
    55a0:	e118                	sd	a4,0(a0)
    55a2:	a899                	j	55f8 <malloc+0xd0>
  hp->s.size = nu;
    55a4:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    55a8:	0541                	addi	a0,a0,16
    55aa:	ef9ff0ef          	jal	54a2 <free>
  return freep;
    55ae:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    55b0:	c125                	beqz	a0,5610 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    55b2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    55b4:	4798                	lw	a4,8(a5)
    55b6:	03277163          	bgeu	a4,s2,55d8 <malloc+0xb0>
    if(p == freep)
    55ba:	6098                	ld	a4,0(s1)
    55bc:	853e                	mv	a0,a5
    55be:	fef71ae3          	bne	a4,a5,55b2 <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    55c2:	8552                	mv	a0,s4
    55c4:	9f3ff0ef          	jal	4fb6 <sbrk>
  if(p == SBRK_ERROR)
    55c8:	fd551ee3          	bne	a0,s5,55a4 <malloc+0x7c>
        return 0;
    55cc:	4501                	li	a0,0
    55ce:	74a2                	ld	s1,40(sp)
    55d0:	6a42                	ld	s4,16(sp)
    55d2:	6aa2                	ld	s5,8(sp)
    55d4:	6b02                	ld	s6,0(sp)
    55d6:	a03d                	j	5604 <malloc+0xdc>
    55d8:	74a2                	ld	s1,40(sp)
    55da:	6a42                	ld	s4,16(sp)
    55dc:	6aa2                	ld	s5,8(sp)
    55de:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    55e0:	fae90fe3          	beq	s2,a4,559e <malloc+0x76>
        p->s.size -= nunits;
    55e4:	4137073b          	subw	a4,a4,s3
    55e8:	c798                	sw	a4,8(a5)
        p += p->s.size;
    55ea:	02071693          	slli	a3,a4,0x20
    55ee:	01c6d713          	srli	a4,a3,0x1c
    55f2:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    55f4:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    55f8:	00003717          	auipc	a4,0x3
    55fc:	e8a73c23          	sd	a0,-360(a4) # 8490 <freep>
      return (void*)(p + 1);
    5600:	01078513          	addi	a0,a5,16
  }
}
    5604:	70e2                	ld	ra,56(sp)
    5606:	7442                	ld	s0,48(sp)
    5608:	7902                	ld	s2,32(sp)
    560a:	69e2                	ld	s3,24(sp)
    560c:	6121                	addi	sp,sp,64
    560e:	8082                	ret
    5610:	74a2                	ld	s1,40(sp)
    5612:	6a42                	ld	s4,16(sp)
    5614:	6aa2                	ld	s5,8(sp)
    5616:	6b02                	ld	s6,0(sp)
    5618:	b7f5                	j	5604 <malloc+0xdc>
