...
user/_useradd:     file format elf64-littleriscv
...
main(int argc, char *argv[])
{
  ...
  1a:	94a58593          	addi	a1,a1,-1718 # 960 <malloc+0xf8>
  1e:	4509                	li	a0,2
  20:	766000ef          	jal	786 <fprintf>
    exit(1);
  24:	4505                	li	a0,1
  26:	304000ef          	jal	32a <exit>
  2a:	ec26                	sd	s1,24(sp)
  2c:	e84a                	sd	s2,16(sp)
  2e:	e44e                	sd	s3,8(sp)
  30:	e052                	sd	s4,0(sp)
  ...
  34:	0085b903          	ld	s2,8(a1)
  38:	0105b983          	ld	s3,16(a1)
  3c:	6d88                	ld	a0,24(a1)
  3e:	1c2000ef          	jal	200 <atoi>
  42:	8a2a                	mv	s4,a0
  44:	7088                	ld	a0,32(s1)
  46:	1ba000ef          	jal	200 <atoi>
  4a:	86aa                	mv	a3,a0
  4c:	8652                	mv	a2,s4
  4e:	85ce                	mv	a1,s3
  50:	854a                	mv	a0,s2
  52:	380000ef          	jal	3d2 <useradd>
  56:	00054563          	bltz	a0,60 <main+0x60>
  ...
  exit(0);
  5a:	4501                	li	a0,0
  5c:	2ce000ef          	jal	32a <exit>
    fprintf(2, "useradd failed\n");
  60:	00001597          	auipc	a1,0x1
  64:	93058593          	addi	a1,a1,-1744 # 990 <malloc+0x128>
  68:	4509                	li	a0,2
  6a:	71c000ef          	jal	786 <fprintf>
    exit(1);
  6e:	4505                	li	a0,1
  70:	2ba000ef          	jal	32a <exit>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 44e:	55e80813          	addi	a6,a6,1374 # 9a8 <digits>
 452:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 672:	33ab8b93          	addi	s7,s7,826 # 9a8 <digits>
 ...
 6d0:	2d448493          	addi	s1,s1,724 # 9a0 <malloc+0x138>
        for(; *s; s++)
