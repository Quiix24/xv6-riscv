...
cat(int fd)
{
  ...
  44:	9a058593          	addi	a1,a1,-1632 # 9e0 <malloc+0xf6>
  48:	4509                	li	a0,2
  4a:	7be000ef          	jal	808 <fprintf>
      exit(1);
  4e:	4505                	li	a0,1
  ...
  6e:	98e58593          	addi	a1,a1,-1650 # 9f8 <malloc+0x10e>
  72:	4509                	li	a0,2
  74:	794000ef          	jal	808 <fprintf>
    exit(1);
  78:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  e6:	92e58593          	addi	a1,a1,-1746 # a10 <malloc+0x126>
  ea:	4509                	li	a0,2
  ec:	71c000ef          	jal	808 <fprintf>
      exit(1);
  f0:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 4d0:	56480813          	addi	a6,a6,1380 # a30 <digits>
 4d4:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6f4:	340b8b93          	addi	s7,s7,832 # a30 <digits>
 ...
 752:	2da48493          	addi	s1,s1,730 # a28 <malloc+0x13e>
        for(; *s; s++)
