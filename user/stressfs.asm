...
main(int argc, char *argv[])
{
  ...
  22:	9e278793          	addi	a5,a5,-1566 # a00 <malloc+0x124>
  26:	6398                	ld	a4,0(a5)
  ...
  38:	99c50513          	addi	a0,a0,-1636 # 9d0 <malloc+0xf4>
  3c:	7e8000ef          	jal	824 <printf>
  ...
  68:	98450513          	addi	a0,a0,-1660 # 9e8 <malloc+0x10c>
  6c:	7b8000ef          	jal	824 <printf>
...
//    printf(fd, "%d\n", i);
  ...
  aa:	95250513          	addi	a0,a0,-1710 # 9f8 <malloc+0x11c>
  ae:	776000ef          	jal	824 <printf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 4c2:	55a80813          	addi	a6,a6,1370 # a18 <digits>
 4c6:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6e6:	336b8b93          	addi	s7,s7,822 # a18 <digits>
 ...
 744:	2d048493          	addi	s1,s1,720 # a10 <malloc+0x134>
        for(; *s; s++)
