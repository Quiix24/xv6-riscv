...
main(int argc, char **argv)
{
  ...
  10:	97450513          	addi	a0,a0,-1676 # 980 <malloc+0x100>
  14:	396000ef          	jal	3aa <mkdir>
  18:	c919                	beqz	a0,2e <main+0x2e>
    printf("%s: mkdir dd failed\n", s);
  1a:	85a6                	mv	a1,s1
  1c:	00001517          	auipc	a0,0x1
  20:	96c50513          	addi	a0,a0,-1684 # 988 <malloc+0x108>
  ...
  32:	95250513          	addi	a0,a0,-1710 # 980 <malloc+0x100>
  36:	37c000ef          	jal	3b2 <chdir>
  3a:	c919                	beqz	a0,50 <main+0x50>
    printf("%s: chdir dd failed\n", s);
  3c:	85a6                	mv	a1,s1
  3e:	00001517          	auipc	a0,0x1
  42:	96250513          	addi	a0,a0,-1694 # 9a0 <malloc+0x120>
  ...
  54:	96850513          	addi	a0,a0,-1688 # 9b8 <malloc+0x138>
  ...
  64:	97850513          	addi	a0,a0,-1672 # 9d8 <malloc+0x158>
  ...
  7e:	94650513          	addi	a0,a0,-1722 # 9c0 <malloc+0x140>
  82:	746000ef          	jal	7c8 <printf>
    exit(1);
  86:	4505                	li	a0,1
