...
main(int argc, char **argv)
{
  ...
  14:	9a050513          	addi	a0,a0,-1632 # 9b0 <malloc+0xf6>
  ...
  30:	98450513          	addi	a0,a0,-1660 # 9b0 <malloc+0xf6>
  ...
  42:	97250513          	addi	a0,a0,-1678 # 9b0 <malloc+0xf6>
  ...
  56:	9be50513          	addi	a0,a0,-1602 # a10 <malloc+0x156>
  ...
  6a:	95a50513          	addi	a0,a0,-1702 # 9c0 <malloc+0x106>
  ...
  7c:	96068693          	addi	a3,a3,-1696 # 9d8 <malloc+0x11e>
  80:	8626                	mv	a2,s1
  82:	00001597          	auipc	a1,0x1
  86:	95e58593          	addi	a1,a1,-1698 # 9e0 <malloc+0x126>
  8a:	4509                	li	a0,2
  ...
  9c:	96050513          	addi	a0,a0,-1696 # 9f8 <malloc+0x13e>
  ...
  b2:	97a50513          	addi	a0,a0,-1670 # a28 <malloc+0x16e>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 4a0:	5b480813          	addi	a6,a6,1460 # a50 <digits>
 4a4:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6c4:	390b8b93          	addi	s7,s7,912 # a50 <digits>
 ...
 722:	32a48493          	addi	s1,s1,810 # a48 <malloc+0x18e>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 91c:	8f078793          	addi	a5,a5,-1808 # 1208 <base>
