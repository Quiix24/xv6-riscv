...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3f8:	52480813          	addi	a6,a6,1316 # 918 <digits>
 3fc:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 61c:	300b8b93          	addi	s7,s7,768 # 918 <digits>
 ...
 67a:	29a48493          	addi	s1,s1,666 # 910 <malloc+0xfe>
        for(; *s; s++)
