...
main(void)
{
  ...
  switch(uid) {
  12:	4785                	li	a5,1
  14:	00001617          	auipc	a2,0x1
  18:	94c60613          	addi	a2,a2,-1716 # 960 <malloc+0x106>
  1c:	02f50c63          	beq	a0,a5,54 <main+0x54>
  20:	4789                	li	a5,2
  22:	02f50563          	beq	a0,a5,4c <main+0x4c>
    case 0: role = "ADMIN"; break;
  26:	00001617          	auipc	a2,0x1
  2a:	92a60613          	addi	a2,a2,-1750 # 950 <malloc+0xf6>
  switch(uid) {
  2e:	c11d                	beqz	a0,54 <main+0x54>
    case 1: role = "PATIENT"; break;
    case 2: role = "DOCTOR"; break;
    default: role = "UNKNOWN"; break;
  30:	00001617          	auipc	a2,0x1
  34:	94060613          	addi	a2,a2,-1728 # 970 <malloc+0x116>
  38:	a831                	j	54 <main+0x54>
    printf("whoami: error getting uid\n");
  3a:	00001517          	auipc	a0,0x1
  3e:	93e50513          	addi	a0,a0,-1730 # 978 <malloc+0x11e>
  42:	760000ef          	jal	7a2 <printf>
    exit(1);
  46:	4505                	li	a0,1
  48:	2d4000ef          	jal	31c <exit>
    case 2: role = "DOCTOR"; break;
  4c:	00001617          	auipc	a2,0x1
  50:	91c60613          	addi	a2,a2,-1764 # 968 <malloc+0x10e>
  }

  printf("Current UID: %d (Role: %s)\n", uid, role);
  54:	00001517          	auipc	a0,0x1
  58:	94450513          	addi	a0,a0,-1724 # 998 <malloc+0x13e>
  5c:	746000ef          	jal	7a2 <printf>
  exit(0);
  60:	4501                	li	a0,0
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 440:	58480813          	addi	a6,a6,1412 # 9c0 <digits>
 444:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 664:	360b8b93          	addi	s7,s7,864 # 9c0 <digits>
 ...
 6c2:	2fa48493          	addi	s1,s1,762 # 9b8 <malloc+0x15e>
        for(; *s; s++)
