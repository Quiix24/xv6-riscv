...
main(int argc, char *argv[])
{
  ...
  14:	93058593          	addi	a1,a1,-1744 # 940 <malloc+0xfe>
  18:	4509                	li	a0,2
  1a:	746000ef          	jal	760 <fprintf>
    exit(1);
  1e:	4505                	li	a0,1
  ...
  42:	91a58593          	addi	a1,a1,-1766 # 958 <malloc+0x116>
  46:	4509                	li	a0,2
  48:	718000ef          	jal	760 <fprintf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 428:	55480813          	addi	a6,a6,1364 # 978 <digits>
 42c:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 64c:	330b8b93          	addi	s7,s7,816 # 978 <digits>
 ...
 6aa:	2ca48493          	addi	s1,s1,714 # 970 <malloc+0x12e>
        for(; *s; s++)
